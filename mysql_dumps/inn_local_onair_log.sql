...
--
-- Table structure for table `onair_log`
--

DROP TABLE IF EXISTS `onair_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `onair_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `service_id` int(11) NOT NULL,
  `room_id` varchar(255) COLLATE utf8mb4_bin NOT NULL,
  `publish_id` varchar(255) COLLATE utf8mb4_bin NOT NULL,
...
--
-- Dumping data for table `onair_log`
--

LOCK TABLES `onair_log` WRITE;
/*!40000 ALTER TABLE `onair_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `onair_log` ENABLE KEYS */;
UNLOCK TABLES;
