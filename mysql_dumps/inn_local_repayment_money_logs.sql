...
--
-- Table structure for table `repayment_money_logs`
--

DROP TABLE IF EXISTS `repayment_money_logs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `repayment_money_logs` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `service_id` int(11) NOT NULL,
  `female_member_id` int(11) NOT NULL,
  `op_pay_id` int(11) NOT NULL,
  `female_point_log_id` int(11) NOT NULL,
  `repayment_at` datetime NOT NULL,
  `repayment_money` int(11) NOT NULL DEFAULT '0',
  ...
  KEY `idx_op_pay_id` (`op_pay_id`),
  KEY `idx_female_point_log_id` (`female_point_log_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `repayment_money_logs`
--

LOCK TABLES `repayment_money_logs` WRITE;
/*!40000 ALTER TABLE `repayment_money_logs` DISABLE KEYS */;
/*!40000 ALTER TABLE `repayment_money_logs` ENABLE KEYS */;
UNLOCK TABLES;
