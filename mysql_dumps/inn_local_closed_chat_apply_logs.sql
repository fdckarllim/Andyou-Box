...
--
-- Table structure for table `closed_chat_apply_logs`
--

DROP TABLE IF EXISTS `closed_chat_apply_logs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `closed_chat_apply_logs` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `service_id` int(11) NOT NULL,
  `male_member_id` int(11) NOT NULL,
  `female_member_id` int(11) NOT NULL,
  `apply_room_id` varchar(255) COLLATE utf8mb4_bin NOT NULL,
  `room_id` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL,
  `room_id_applied` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL,
  `status` varchar(255) COLLATE utf8mb4_bin NOT NULL,
  `applied_at` datetime NOT NULL,
  `cancelled_at` datetime DEFAULT NULL,
  `okayed_at` datetime DEFAULT NULL,
...
--
-- Dumping data for table `closed_chat_apply_logs`
--

LOCK TABLES `closed_chat_apply_logs` WRITE;
/*!40000 ALTER TABLE `closed_chat_apply_logs` DISABLE KEYS */;
/*!40000 ALTER TABLE `closed_chat_apply_logs` ENABLE KEYS */;
UNLOCK TABLES;
