...
--
-- Table structure for table `variety_event_groups`
--

DROP TABLE IF EXISTS `variety_event_groups`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `variety_event_groups` (
...
--
-- Dumping data for table `variety_event_groups`
--

LOCK TABLES `variety_event_groups` WRITE;
/*!40000 ALTER TABLE `variety_event_groups` DISABLE KEYS */;
/*!40000 ALTER TABLE `variety_event_groups` ENABLE KEYS */;
UNLOCK TABLES;
