...
--
-- Table structure for table `member_performer_entries`
--

DROP TABLE IF EXISTS `member_performer_entries`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `member_performer_entries` (
...
--
-- Dumping data for table `member_performer_entries`
--

LOCK TABLES `member_performer_entries` WRITE;
/*!40000 ALTER TABLE `member_performer_entries` DISABLE KEYS */;
/*!40000 ALTER TABLE `member_performer_entries` ENABLE KEYS */;
UNLOCK TABLES;
