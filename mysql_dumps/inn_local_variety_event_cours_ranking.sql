...
--
-- Table structure for table `variety_event_cours_ranking`
--

DROP TABLE IF EXISTS `variety_event_cours_ranking`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `variety_event_cours_ranking` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `variety_event_cours_id` int(11) NOT NULL,
  `department_name_1` varchar(255) COLLATE utf8mb4_bin NOT NULL,
  `department_name_2` varchar(255) COLLATE utf8mb4_bin NOT NULL,
...
--
-- Dumping data for table `variety_event_cours_ranking`
--

LOCK TABLES `variety_event_cours_ranking` WRITE;
/*!40000 ALTER TABLE `variety_event_cours_ranking` DISABLE KEYS */;
/*!40000 ALTER TABLE `variety_event_cours_ranking` ENABLE KEYS */;
UNLOCK TABLES;
