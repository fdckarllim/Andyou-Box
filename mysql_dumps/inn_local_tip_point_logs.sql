...
--
-- Table structure for table `tip_point_logs`
--

DROP TABLE IF EXISTS `tip_point_logs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tip_point_logs` (
...
--
-- Dumping data for table `tip_point_logs`
--

LOCK TABLES `tip_point_logs` WRITE;
/*!40000 ALTER TABLE `tip_point_logs` DISABLE KEYS */;
/*!40000 ALTER TABLE `tip_point_logs` ENABLE KEYS */;
UNLOCK TABLES;
