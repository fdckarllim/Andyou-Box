...
--
-- Table structure for table `talent_private_offices`
--

DROP TABLE IF EXISTS `talent_private_offices`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `talent_private_offices` (
  ...
  `representative_mail` varchar(1023) COLLATE utf8mb4_bin NOT NULL,
  `representative_phone` varchar(255) COLLATE utf8mb4_bin NOT NULL,
...
--
-- Dumping data for table `talent_private_offices`
--

LOCK TABLES `talent_private_offices` WRITE;
/*!40000 ALTER TABLE `talent_private_offices` DISABLE KEYS */;
/*!40000 ALTER TABLE `talent_private_offices` ENABLE KEYS */;
UNLOCK TABLES;
