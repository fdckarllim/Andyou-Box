...
--
-- Table structure for table `performer_total_points`
--

DROP TABLE IF EXISTS `performer_total_points`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `performer_total_points` (
...
--
-- Dumping data for table `performer_total_points`
--

LOCK TABLES `performer_total_points` WRITE;
/*!40000 ALTER TABLE `performer_total_points` DISABLE KEYS */;
/*!40000 ALTER TABLE `performer_total_points` ENABLE KEYS */;
UNLOCK TABLES;
