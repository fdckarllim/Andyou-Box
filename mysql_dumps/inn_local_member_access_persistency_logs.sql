...
--
-- Table structure for table `member_access_persistency_logs`
--

DROP TABLE IF EXISTS `member_access_persistency_logs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `member_access_persistency_logs` (
...
--
-- Dumping data for table `member_access_persistency_logs`
--

LOCK TABLES `member_access_persistency_logs` WRITE;
/*!40000 ALTER TABLE `member_access_persistency_logs` DISABLE KEYS */;
INSERT INTO `member_access_persistency_logs` VALUES (1,3,'2017-07-10',1,1,1,1,0,0,1,0,'2017-07-17 10:00:56','127.0.0.1','1','127.0.0.1','3','male_member','male_member','pc','pc','2017-07-11 10:26:54','2017-07-17 10:00:56');
/*!40000 ALTER TABLE `member_access_persistency_logs` ENABLE KEYS */;
UNLOCK TABLES;
