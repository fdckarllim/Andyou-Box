...
--
-- Table structure for table `unit_productions`
--

DROP TABLE IF EXISTS `unit_productions`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `unit_productions` (
...
--
-- Dumping data for table `unit_productions`
--

LOCK TABLES `unit_productions` WRITE;
/*!40000 ALTER TABLE `unit_productions` DISABLE KEYS */;
/*!40000 ALTER TABLE `unit_productions` ENABLE KEYS */;
UNLOCK TABLES;
