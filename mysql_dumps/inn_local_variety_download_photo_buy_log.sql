...
--
-- Table structure for table `variety_download_photo_buy_log`
--

DROP TABLE IF EXISTS `variety_download_photo_buy_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `variety_download_photo_buy_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `male_member_id` int(11) NOT NULL,
  `variety_download_photo_id` int(11) NOT NULL,
...
--
-- Dumping data for table `variety_download_photo_buy_log`
--

LOCK TABLES `variety_download_photo_buy_log` WRITE;
/*!40000 ALTER TABLE `variety_download_photo_buy_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `variety_download_photo_buy_log` ENABLE KEYS */;
UNLOCK TABLES;
