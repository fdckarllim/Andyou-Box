...
CREATE TABLE `payment_dates` (
  ...
  `netbank` int(11) NOT NULL DEFAULT '0',
  `cutoff_day` int(11) NOT NULL DEFAULT '0',
...
LOCK TABLES `payment_dates` WRITE;
/*!40000 ALTER TABLE `payment_dates` DISABLE KEYS */;
/*!40000 ALTER TABLE `payment_dates` ENABLE KEYS */;
UNLOCK TABLES;
