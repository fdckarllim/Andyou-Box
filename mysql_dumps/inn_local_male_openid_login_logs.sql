...
--
-- Table structure for table `male_openid_login_logs`
--

DROP TABLE IF EXISTS `male_openid_login_logs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `male_openid_login_logs` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `service_group_id` int(11) NOT NULL,
  `male_member_id` int(11) NOT NULL,
  `openid` varchar(255) COLLATE utf8mb4_bin NOT NULL,
  `query_string` text COLLATE utf8mb4_bin NOT NULL,
...
--
-- Dumping data for table `male_openid_login_logs`
--

LOCK TABLES `male_openid_login_logs` WRITE;
/*!40000 ALTER TABLE `male_openid_login_logs` DISABLE KEYS */;
/*!40000 ALTER TABLE `male_openid_login_logs` ENABLE KEYS */;
UNLOCK TABLES;
