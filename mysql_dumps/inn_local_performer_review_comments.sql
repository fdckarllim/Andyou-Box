...
--
-- Table structure for table `performer_review_comments`
--

DROP TABLE IF EXISTS `performer_review_comments`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `performer_review_comments` (
...
--
-- Dumping data for table `performer_review_comments`
--

LOCK TABLES `performer_review_comments` WRITE;
/*!40000 ALTER TABLE `performer_review_comments` DISABLE KEYS */;
/*!40000 ALTER TABLE `performer_review_comments` ENABLE KEYS */;
UNLOCK TABLES;
