...
--
-- Table structure for table `variety_event_movies`
--

DROP TABLE IF EXISTS `variety_event_movies`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `variety_event_movies` (
...
--
-- Dumping data for table `variety_event_movies`
--

LOCK TABLES `variety_event_movies` WRITE;
/*!40000 ALTER TABLE `variety_event_movies` DISABLE KEYS */;
/*!40000 ALTER TABLE `variety_event_movies` ENABLE KEYS */;
UNLOCK TABLES;
