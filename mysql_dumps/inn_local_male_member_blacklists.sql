...
--
-- Table structure for table `male_member_blacklists`
--

DROP TABLE IF EXISTS `male_member_blacklists`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `male_member_blacklists` (
...
--
-- Dumping data for table `male_member_blacklists`
--

LOCK TABLES `male_member_blacklists` WRITE;
/*!40000 ALTER TABLE `male_member_blacklists` DISABLE KEYS */;
/*!40000 ALTER TABLE `male_member_blacklists` ENABLE KEYS */;
UNLOCK TABLES;
