...
--
-- Table structure for table `variety_recommend_comments`
--

DROP TABLE IF EXISTS `variety_recommend_comments`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `variety_recommend_comments` (
...
--
-- Dumping data for table `variety_recommend_comments`
--

LOCK TABLES `variety_recommend_comments` WRITE;
/*!40000 ALTER TABLE `variety_recommend_comments` DISABLE KEYS */;
/*!40000 ALTER TABLE `variety_recommend_comments` ENABLE KEYS */;
UNLOCK TABLES;
