...
--
-- Table structure for table `variety_eventer_staffs`
--

DROP TABLE IF EXISTS `variety_eventer_staffs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `variety_eventer_staffs` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `variety_eventer_id` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL,
  `name_kana` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL,
...
--
-- Dumping data for table `variety_eventer_staffs`
--

LOCK TABLES `variety_eventer_staffs` WRITE;
/*!40000 ALTER TABLE `variety_eventer_staffs` DISABLE KEYS */;
INSERT INTO `variety_eventer_staffs` VALUES (1,1,'testEventerA',NULL,'testEventerA@testEventerA.com','12345',NULL,'testEventerA','testEventerA','2017-01-03 09:00:00','2017-01-03 09:00:00','127.0.0.1','1','127.0.0.1','1','admin','admin','PC',NULL,'2017-01-03 09:00:00','2017-01-03 09:00:00');
/*!40000 ALTER TABLE `variety_eventer_staffs` ENABLE KEYS */;
UNLOCK TABLES;
