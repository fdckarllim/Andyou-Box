...
--
-- Table structure for table `macherie_performer_targets`
--

DROP TABLE IF EXISTS `macherie_performer_targets`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `macherie_performer_targets` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `female_member_id` int(11) NOT NULL,
  `period_from` date NOT NULL,
  `period_to` date NOT NULL,
  `target_coin` int(11) NOT NULL,
...
--
-- Dumping data for table `macherie_performer_targets`
--

LOCK TABLES `macherie_performer_targets` WRITE;
/*!40000 ALTER TABLE `macherie_performer_targets` DISABLE KEYS */;
/*!40000 ALTER TABLE `macherie_performer_targets` ENABLE KEYS */;
UNLOCK TABLES;
