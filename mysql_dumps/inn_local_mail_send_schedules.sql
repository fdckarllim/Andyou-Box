...
--
-- Table structure for table `mail_send_schedules`
--

DROP TABLE IF EXISTS `mail_send_schedules`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mail_send_schedules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `agent_mail_id` int(11) DEFAULT NULL,
  `member_mail_send_log_id` int(11) DEFAULT NULL,
  `performer_mail_send_log_id` int(11) DEFAULT NULL,
  `macherie_agent_id` int(11) DEFAULT NULL,
  `male_member_id` int(11) DEFAULT NULL,
  `female_member_id` int(11) DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `idx_agent_mail_id` (`agent_mail_id`),
  KEY `idx_member_mail_send_log_id` (`member_mail_send_log_id`),
  KEY `idx_performer_mail_send_log_id` (`performer_mail_send_log_id`),
  KEY `idx_macherie_agent_id` (`macherie_agent_id`),
...
--
-- Dumping data for table `mail_send_schedules`
--

LOCK TABLES `mail_send_schedules` WRITE;
/*!40000 ALTER TABLE `mail_send_schedules` DISABLE KEYS */;
/*!40000 ALTER TABLE `mail_send_schedules` ENABLE KEYS */;
UNLOCK TABLES;
