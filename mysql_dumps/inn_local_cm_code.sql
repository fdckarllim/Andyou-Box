...
--
-- Table structure for table `cm_code`
--
...
CREATE TABLE `cm_code` (
  ...
  `cm_key` varchar(255) COLLATE utf8mb4_bin NOT NULL,
  `cm_value` varchar(255) COLLATE utf8mb4_bin NOT NULL,
...
--
-- Dumping data for table `cm_code`
--
