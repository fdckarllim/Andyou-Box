...
--
-- Table structure for table `variety_recommend_comment_logs`
--

DROP TABLE IF EXISTS `variety_recommend_comment_logs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `variety_recommend_comment_logs` (
  ...
  `checked_comment` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL,
  `status` varchar(255) COLLATE utf8mb4_bin NOT NULL DEFAULT 'unchecked',
...
--
-- Dumping data for table `variety_recommend_comment_logs`
--

LOCK TABLES `variety_recommend_comment_logs` WRITE;
/*!40000 ALTER TABLE `variety_recommend_comment_logs` DISABLE KEYS */;
/*!40000 ALTER TABLE `variety_recommend_comment_logs` ENABLE KEYS */;
UNLOCK TABLES;
