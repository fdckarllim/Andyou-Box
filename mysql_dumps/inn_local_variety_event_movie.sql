...
--
-- Table structure for table `variety_event_movie`
--

DROP TABLE IF EXISTS `variety_event_movie`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `variety_event_movie` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `variety_event_cours_id` int(11) NOT NULL,
  `variety_event_performer_id` int(11) NOT NULL,
  `male_member_id` int(11) NOT NULL,
  `tiltle` varchar(255) COLLATE utf8mb4_bin NOT NULL,
  `description` text COLLATE utf8mb4_bin NOT NULL,
  `movie_file` varchar(255) COLLATE utf8mb4_bin NOT NULL,
...
--
-- Dumping data for table `variety_event_movie`
--

LOCK TABLES `variety_event_movie` WRITE;
/*!40000 ALTER TABLE `variety_event_movie` DISABLE KEYS */;
/*!40000 ALTER TABLE `variety_event_movie` ENABLE KEYS */;
UNLOCK TABLES;
