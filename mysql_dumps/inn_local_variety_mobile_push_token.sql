...
--
-- Table structure for table `variety_mobile_push_token`
--

DROP TABLE IF EXISTS `variety_mobile_push_token`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `variety_mobile_push_token` (
  ...
  `is_avaiable` tinyint(1) NOT NULL DEFAULT '1' COMMENT '有効フラグ',
...
--
-- Dumping data for table `variety_mobile_push_token`
--

LOCK TABLES `variety_mobile_push_token` WRITE;
/*!40000 ALTER TABLE `variety_mobile_push_token` DISABLE KEYS */;
/*!40000 ALTER TABLE `variety_mobile_push_token` ENABLE KEYS */;
UNLOCK TABLES;
