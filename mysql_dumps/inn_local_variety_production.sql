...
--
-- Table structure for table `variety_production`
--

DROP TABLE IF EXISTS `variety_production`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `variety_production` (
  ...
  `logo_image` varchar(1023) COLLATE utf8mb4_bin DEFAULT NULL,
  `site_url` varchar(1023) COLLATE utf8mb4_bin DEFAULT NULL,
  `representative_name` varchar(255) COLLATE utf8mb4_bin NOT NULL,
...
--
-- Dumping data for table `variety_production`
--

LOCK TABLES `variety_production` WRITE;
/*!40000 ALTER TABLE `variety_production` DISABLE KEYS */;
/*!40000 ALTER TABLE `variety_production` ENABLE KEYS */;
UNLOCK TABLES;
