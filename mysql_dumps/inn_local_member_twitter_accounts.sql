...
--
-- Table structure for table `member_twitter_accounts`
--

DROP TABLE IF EXISTS `member_twitter_accounts`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `member_twitter_accounts` (
  ...
  `access_token_secret` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL,
...
--
-- Dumping data for table `member_twitter_accounts`
--

LOCK TABLES `member_twitter_accounts` WRITE;
/*!40000 ALTER TABLE `member_twitter_accounts` DISABLE KEYS */;
/*!40000 ALTER TABLE `member_twitter_accounts` ENABLE KEYS */;
UNLOCK TABLES;
