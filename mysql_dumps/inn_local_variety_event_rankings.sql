...
--
-- Table structure for table `variety_event_rankings`
--

DROP TABLE IF EXISTS `variety_event_rankings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `variety_event_rankings` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `variety_event_ranking_term_id` int(11) NOT NULL,
...
--
-- Dumping data for table `variety_event_rankings`
--

LOCK TABLES `variety_event_rankings` WRITE;
/*!40000 ALTER TABLE `variety_event_rankings` DISABLE KEYS */;
/*!40000 ALTER TABLE `variety_event_rankings` ENABLE KEYS */;
UNLOCK TABLES;
