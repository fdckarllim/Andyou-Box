...
--
-- Table structure for table `variety_clearing_fixed_event_amount_logs`
--

DROP TABLE IF EXISTS `variety_clearing_fixed_event_amount_logs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `variety_clearing_fixed_event_amount_logs` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `period` int(11) NOT NULL,
  `variety_event_id` int(11) DEFAULT NULL,
  `variety_event_name` varchar(255) COLLATE utf8mb4_bin NOT NULL,
...
--
-- Dumping data for table `variety_clearing_fixed_event_amount_logs`
--

LOCK TABLES `variety_clearing_fixed_event_amount_logs` WRITE;
/*!40000 ALTER TABLE `variety_clearing_fixed_event_amount_logs` DISABLE KEYS */;
/*!40000 ALTER TABLE `variety_clearing_fixed_event_amount_logs` ENABLE KEYS */;
UNLOCK TABLES;
