...
--
-- Table structure for table `female_mails`
--

DROP TABLE IF EXISTS `female_mails`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `female_mails` (
  ...
  `admin_send_flag` int(11) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `female_mails`
--

LOCK TABLES `female_mails` WRITE;
/*!40000 ALTER TABLE `female_mails` DISABLE KEYS */;
/*!40000 ALTER TABLE `female_mails` ENABLE KEYS */;
UNLOCK TABLES;
