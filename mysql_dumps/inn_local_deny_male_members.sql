...
--
-- Table structure for table `deny_male_members`
--

DROP TABLE IF EXISTS `deny_male_members`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `deny_male_members` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `service_group_id` int(11) NOT NULL,
  `female_member_id` int(11) NOT NULL,
  `male_member_id` int(11) NOT NULL,
  `male_member_kick_reason` varchar(255) COLLATE utf8mb4_bin NOT NULL,
...
--
-- Dumping data for table `deny_male_members`
--

LOCK TABLES `deny_male_members` WRITE;
/*!40000 ALTER TABLE `deny_male_members` DISABLE KEYS */;
/*!40000 ALTER TABLE `deny_male_members` ENABLE KEYS */;
UNLOCK TABLES;
