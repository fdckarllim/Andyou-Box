...
--
-- Table structure for table `variety_event_dlc_files`
--

DROP TABLE IF EXISTS `variety_event_dlc_files`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `variety_event_dlc_files` (
...
--
-- Dumping data for table `variety_event_dlc_files`
--

LOCK TABLES `variety_event_dlc_files` WRITE;
/*!40000 ALTER TABLE `variety_event_dlc_files` DISABLE KEYS */;
/*!40000 ALTER TABLE `variety_event_dlc_files` ENABLE KEYS */;
UNLOCK TABLES;
