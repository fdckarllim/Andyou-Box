...
--
-- Table structure for table `male_mail_forward_setting`
--

DROP TABLE IF EXISTS `male_mail_forward_setting`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `male_mail_forward_setting` (
...
--
-- Dumping data for table `male_mail_forward_setting`
--

LOCK TABLES `male_mail_forward_setting` WRITE;
/*!40000 ALTER TABLE `male_mail_forward_setting` DISABLE KEYS */;
/*!40000 ALTER TABLE `male_mail_forward_setting` ENABLE KEYS */;
UNLOCK TABLES;
