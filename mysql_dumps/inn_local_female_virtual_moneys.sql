...
--
-- Table structure for table `female_virtual_moneys`
--

DROP TABLE IF EXISTS `female_virtual_moneys`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `female_virtual_moneys` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `service_group_id` int(11) NOT NULL,
  `female_member_id` int(11) NOT NULL,
  `virtual_money_id` int(11) NOT NULL,
  `virtual_money` decimal(9,1) NOT NULL DEFAULT '0.0',
  `virtual_money_old` decimal(9,1) NOT NULL DEFAULT '0.0',
  `virtual_money_total` decimal(9,1) NOT NULL DEFAULT '0.0',
...
--
-- Dumping data for table `female_virtual_moneys`
--

LOCK TABLES `female_virtual_moneys` WRITE;
/*!40000 ALTER TABLE `female_virtual_moneys` DISABLE KEYS */;
/*!40000 ALTER TABLE `female_virtual_moneys` ENABLE KEYS */;
UNLOCK TABLES;
