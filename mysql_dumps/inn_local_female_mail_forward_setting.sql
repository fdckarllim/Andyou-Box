...
--
-- Table structure for table `female_mail_forward_setting`
--

DROP TABLE IF EXISTS `female_mail_forward_setting`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `female_mail_forward_setting` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `female_member_id` int(11) NOT NULL,
  `receive_flag` int(11) NOT NULL,
  `system_call_receive_flag` int(11) NOT NULL,
  `deny_time_from` varchar(255) COLLATE utf8mb4_bin NOT NULL,
  `deny_time_to` varchar(255) COLLATE utf8mb4_bin NOT NULL,
...
--
-- Dumping data for table `female_mail_forward_setting`
--

LOCK TABLES `female_mail_forward_setting` WRITE;
/*!40000 ALTER TABLE `female_mail_forward_setting` DISABLE KEYS */;
/*!40000 ALTER TABLE `female_mail_forward_setting` ENABLE KEYS */;
UNLOCK TABLES;
