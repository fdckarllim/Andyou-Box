...
--
-- Table structure for table `variety_chat_room_users`
--

DROP TABLE IF EXISTS `variety_chat_room_users`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `variety_chat_room_users` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_variety_chat_room_id` (`variety_chat_room_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `variety_chat_room_users`
--

LOCK TABLES `variety_chat_room_users` WRITE;
/*!40000 ALTER TABLE `variety_chat_room_users` DISABLE KEYS */;
/*!40000 ALTER TABLE `variety_chat_room_users` ENABLE KEYS */;
UNLOCK TABLES;
