...
--
-- Table structure for table `variety_infos`
--

DROP TABLE IF EXISTS `variety_infos`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `variety_infos` (
...
--
-- Dumping data for table `variety_infos`
--

LOCK TABLES `variety_infos` WRITE;
/*!40000 ALTER TABLE `variety_infos` DISABLE KEYS */;
/*!40000 ALTER TABLE `variety_infos` ENABLE KEYS */;
UNLOCK TABLES;
