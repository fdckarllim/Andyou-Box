...
--
-- Table structure for table `macherie_agent_targets`
--

DROP TABLE IF EXISTS `macherie_agent_targets`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `macherie_agent_targets` (
...
--
-- Dumping data for table `macherie_agent_targets`
--

LOCK TABLES `macherie_agent_targets` WRITE;
/*!40000 ALTER TABLE `macherie_agent_targets` DISABLE KEYS */;
/*!40000 ALTER TABLE `macherie_agent_targets` ENABLE KEYS */;
UNLOCK TABLES;
