...
--
-- Table structure for table `variety_event`
--

DROP TABLE IF EXISTS `variety_event`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `variety_event` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `variety_event_group_id` int(11) NOT NULL DEFAULT '0',
  `name` varchar(255) COLLATE utf8mb4_bin NOT NULL,
  `description_1` text COLLATE utf8mb4_bin NOT NULL,
  `description_2` text COLLATE utf8mb4_bin NOT NULL,
  ...
  `charge_point` float NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `variety_event`
--

LOCK TABLES `variety_event` WRITE;
/*!40000 ALTER TABLE `variety_event` DISABLE KEYS */;
/*!40000 ALTER TABLE `variety_event` ENABLE KEYS */;
UNLOCK TABLES;
