...
--
-- Table structure for table `variety_chat_room_admin_monitor_logs`
--

DROP TABLE IF EXISTS `variety_chat_room_admin_monitor_logs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `variety_chat_room_admin_monitor_logs` (
...
--
-- Dumping data for table `variety_chat_room_admin_monitor_logs`
--

LOCK TABLES `variety_chat_room_admin_monitor_logs` WRITE;
/*!40000 ALTER TABLE `variety_chat_room_admin_monitor_logs` DISABLE KEYS */;
/*!40000 ALTER TABLE `variety_chat_room_admin_monitor_logs` ENABLE KEYS */;
UNLOCK TABLES;
