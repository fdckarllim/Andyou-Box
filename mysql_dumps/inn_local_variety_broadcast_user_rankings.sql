...
--
-- Table structure for table `variety_broadcast_user_rankings`
--

DROP TABLE IF EXISTS `variety_broadcast_user_rankings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `variety_broadcast_user_rankings` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `variety_chat_room_id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `user_name` varchar(255) COLLATE utf8mb4_bin NOT NULL,
  `icon_image_url` varchar(1023) COLLATE utf8mb4_bin NOT NULL,
...
--
-- Dumping data for table `variety_broadcast_user_rankings`
--

LOCK TABLES `variety_broadcast_user_rankings` WRITE;
/*!40000 ALTER TABLE `variety_broadcast_user_rankings` DISABLE KEYS */;
/*!40000 ALTER TABLE `variety_broadcast_user_rankings` ENABLE KEYS */;
UNLOCK TABLES;
