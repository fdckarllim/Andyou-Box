...
--
-- Table structure for table `variety_text_chat_logs`
--

DROP TABLE IF EXISTS `variety_text_chat_logs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `variety_text_chat_logs` (
...
--
-- Dumping data for table `variety_text_chat_logs`
--

LOCK TABLES `variety_text_chat_logs` WRITE;
/*!40000 ALTER TABLE `variety_text_chat_logs` DISABLE KEYS */;
/*!40000 ALTER TABLE `variety_text_chat_logs` ENABLE KEYS */;
UNLOCK TABLES;
