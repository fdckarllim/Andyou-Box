...
--
-- Table structure for table `variety_event_gifting_templates`
--

DROP TABLE IF EXISTS `variety_event_gifting_templates`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `variety_event_gifting_templates` (
...
--
-- Dumping data for table `variety_event_gifting_templates`
--

LOCK TABLES `variety_event_gifting_templates` WRITE;
/*!40000 ALTER TABLE `variety_event_gifting_templates` DISABLE KEYS */;
/*!40000 ALTER TABLE `variety_event_gifting_templates` ENABLE KEYS */;
UNLOCK TABLES;
