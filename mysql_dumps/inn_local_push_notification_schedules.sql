...
--
-- Table structure for table `push_notification_schedules`
--

DROP TABLE IF EXISTS `push_notification_schedules`;
...
--
-- Dumping data for table `push_notification_schedules`
--

LOCK TABLES `push_notification_schedules` WRITE;
/*!40000 ALTER TABLE `push_notification_schedules` DISABLE KEYS */;
/*!40000 ALTER TABLE `push_notification_schedules` ENABLE KEYS */;
UNLOCK TABLES;
