...
--
-- Table structure for table `variety_media_staff`
--

DROP TABLE IF EXISTS `variety_media_staff`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `variety_media_staff` (
...
--
-- Dumping data for table `variety_media_staff`
--

LOCK TABLES `variety_media_staff` WRITE;
/*!40000 ALTER TABLE `variety_media_staff` DISABLE KEYS */;
/*!40000 ALTER TABLE `variety_media_staff` ENABLE KEYS */;
UNLOCK TABLES;
