...
--
-- Table structure for table `macherie_promotion_areas`
--

DROP TABLE IF EXISTS `macherie_promotion_areas`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `macherie_promotion_areas` (
...
--
-- Dumping data for table `macherie_promotion_areas`
--

LOCK TABLES `macherie_promotion_areas` WRITE;
/*!40000 ALTER TABLE `macherie_promotion_areas` DISABLE KEYS */;
INSERT INTO `macherie_promotion_areas` VALUES (1,NULL,'2017-08-09',NULL,'2017-08-09','2017-08-16',1,1,'www.google.com','member',21,'2017-08-09 10:21:37','127.0.0.1','1','2017-08-09 10:21:37','127.0.0.1','1','admin','admin',NULL,NULL,'2017-08-09 10:21:37','2017-08-09 10:21:37');
/*!40000 ALTER TABLE `macherie_promotion_areas` ENABLE KEYS */;
UNLOCK TABLES;
