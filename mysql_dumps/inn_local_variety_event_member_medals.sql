...
--
-- Table structure for table `variety_event_member_medals`
--

DROP TABLE IF EXISTS `variety_event_member_medals`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `variety_event_member_medals` (
...
--
-- Dumping data for table `variety_event_member_medals`
--

LOCK TABLES `variety_event_member_medals` WRITE;
/*!40000 ALTER TABLE `variety_event_member_medals` DISABLE KEYS */;
/*!40000 ALTER TABLE `variety_event_member_medals` ENABLE KEYS */;
UNLOCK TABLES;
