...
--
-- Table structure for table `gifting_template_details`
--

DROP TABLE IF EXISTS `gifting_template_details`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `gifting_template_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `service_id` int(11) NOT NULL,
  `gifting_template_id` int(11) NOT NULL,
  ...
  KEY `idx_gifting_template_id` (`gifting_template_id`),
...
--
-- Dumping data for table `gifting_template_details`
--

LOCK TABLES `gifting_template_details` WRITE;
/*!40000 ALTER TABLE `gifting_template_details` DISABLE KEYS */;
INSERT INTO `gifting_template_details` VALUES (1,2,1,1,3,'testGiftingItemA','','','',0,'randomTypeA','{level:1}',1,0,0,0,100,1,0,1,0,0,0,0,0,0.000,1000000000,1000000000,'anyone',0,NULL,0,0,NULL,0,0,NULL,NULL,'','','2017-05-31 15:27:05','127.0.0.1','1','2017-05-31 15:27:05','127.0.0.1','1','admin','admin','pc','pc','2017-05-31 15:27:05','2017-05-31 15:27:05'),(2,1,2,2,5,'Gifting new','ooiri','','Y',0,'randomTypeA','{level:1}',1,0,0,0,1,10,0,0,0,0,0,0,0,0.000,1,1,'anyone',1,'Gifting',1,0,NULL,1,0,1,0,NULL,'','2017-07-10 17:12:59','127.0.0.1','1','2017-07-10 11:57:23','127.0.0.1','1','admin','admin','pc','pc','2017-07-10 11:57:34','2017-07-10 17:12:59'),(3,1,2,3,7,'new2','verygood','Caption','y',0,'randomTypeA','{level:1}',2,0,0,0,1,5,0,0,0,0,0,0,0,0.000,1,1,'anyone',0,NULL,0,0,NULL,0,0,NULL,0,NULL,'','2017-07-10 17:12:59','127.0.0.1','1','2017-07-10 17:12:59','127.0.0.1','1','admin','admin','pc','pc','2017-07-10 17:12:59','2017-07-10 17:12:59');
/*!40000 ALTER TABLE `gifting_template_details` ENABLE KEYS */;
UNLOCK TABLES;
