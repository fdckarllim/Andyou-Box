...
--
-- Table structure for table `member_ng_performers`
--

DROP TABLE IF EXISTS `member_ng_performers`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `member_ng_performers` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `male_member_id` int(11) NOT NULL,
  `female_member_id` int(11) NOT NULL,
  `status` varchar(255) COLLATE utf8mb4_bin DEFAULT 'enabled',
...
--
-- Dumping data for table `member_ng_performers`
--

LOCK TABLES `member_ng_performers` WRITE;
/*!40000 ALTER TABLE `member_ng_performers` DISABLE KEYS */;
/*!40000 ALTER TABLE `member_ng_performers` ENABLE KEYS */;
UNLOCK TABLES;
