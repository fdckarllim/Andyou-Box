...
--
-- Table structure for table `performer_running_daily_summary_logs`
--

DROP TABLE IF EXISTS `performer_running_daily_summary_logs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `performer_running_daily_summary_logs` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `date` date NOT NULL,
  `is_agent_performer` tinyint(1) NOT NULL DEFAULT '0',
  `chat_mode` varchar(255) COLLATE utf8mb4_bin NOT NULL,
  `performer_count` int(11) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `performer_running_daily_summary_logs`
--

LOCK TABLES `performer_running_daily_summary_logs` WRITE;
/*!40000 ALTER TABLE `performer_running_daily_summary_logs` DISABLE KEYS */;
/*!40000 ALTER TABLE `performer_running_daily_summary_logs` ENABLE KEYS */;
UNLOCK TABLES;
