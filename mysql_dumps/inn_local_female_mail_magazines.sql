...
--
-- Table structure for table `female_mail_magazines`
--

DROP TABLE IF EXISTS `female_mail_magazines`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `female_mail_magazines` (
  ...
  KEY `idx_mail_magazine_id` (`mail_magazine_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `female_mail_magazines`
--

LOCK TABLES `female_mail_magazines` WRITE;
/*!40000 ALTER TABLE `female_mail_magazines` DISABLE KEYS */;
/*!40000 ALTER TABLE `female_mail_magazines` ENABLE KEYS */;
UNLOCK TABLES;
