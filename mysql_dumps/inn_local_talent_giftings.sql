...
--
-- Table structure for table `talent_giftings`
--

DROP TABLE IF EXISTS `talent_giftings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `talent_giftings` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `talent_id` int(11) NOT NULL,
  `gifting_id` int(11) NOT NULL,
  `usable_broadcast_mode` varchar(255) COLLATE utf8mb4_bin NOT NULL DEFAULT 'all',
...
--
-- Dumping data for table `talent_giftings`
--

LOCK TABLES `talent_giftings` WRITE;
/*!40000 ALTER TABLE `talent_giftings` DISABLE KEYS */;
/*!40000 ALTER TABLE `talent_giftings` ENABLE KEYS */;
UNLOCK TABLES;
