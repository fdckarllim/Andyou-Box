...
--
-- Table structure for table `variety_gifting_logs`
--

DROP TABLE IF EXISTS `variety_gifting_logs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `variety_gifting_logs` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `variety_chat_room_id` int(11) NOT NULL,
  `variety_chat_room_user_id` int(11) NOT NULL,
  ...
  `variety_event_gifting_id` int(11) DEFAULT NULL,
  ...
  `work_flag` tinyint(1) NOT NULL DEFAULT '0',
  ...
  PRIMARY KEY (`id`),
  KEY `idx_variety_gifting_logs_variety_chat_room_id` (`variety_chat_room_id`),
  KEY `idx_male_virtual_money_log_id` (`male_virtual_money_log_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `variety_gifting_logs`
--

LOCK TABLES `variety_gifting_logs` WRITE;
/*!40000 ALTER TABLE `variety_gifting_logs` DISABLE KEYS */;
/*!40000 ALTER TABLE `variety_gifting_logs` ENABLE KEYS */;
UNLOCK TABLES;
