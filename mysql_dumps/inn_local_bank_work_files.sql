...
--
-- Table structure for table `bank_work_files`
--

DROP TABLE IF EXISTS `bank_work_files`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `bank_work_files` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `status` varchar(255) COLLATE utf8mb4_bin NOT NULL DEFAULT 'Unreflected' COMMENT 'Unreflected:反映待ち　.Reflected:本番反映済　.Invalid:無効',
  `reflect_date` datetime DEFAULT NULL,
  `num` int(11) NOT NULL DEFAULT '0',
  `contents_file` int(11) NOT NULL,
...
--
-- Dumping data for table `bank_work_files`
--

LOCK TABLES `bank_work_files` WRITE;
/*!40000 ALTER TABLE `bank_work_files` DISABLE KEYS */;
/*!40000 ALTER TABLE `bank_work_files` ENABLE KEYS */;
UNLOCK TABLES;
