...
--
-- Table structure for table `variety_event_movie_members`
--

DROP TABLE IF EXISTS `variety_event_movie_members`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `variety_event_movie_members` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `variety_event_movie_id` int(11) NOT NULL,
...
--
-- Dumping data for table `variety_event_movie_members`
--

LOCK TABLES `variety_event_movie_members` WRITE;
/*!40000 ALTER TABLE `variety_event_movie_members` DISABLE KEYS */;
/*!40000 ALTER TABLE `variety_event_movie_members` ENABLE KEYS */;
UNLOCK TABLES;
