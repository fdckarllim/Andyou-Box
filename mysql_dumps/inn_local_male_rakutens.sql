...
--
-- Table structure for table `male_rakutens`
--

DROP TABLE IF EXISTS `male_rakutens`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `male_rakutens` (
...
--
-- Dumping data for table `male_rakutens`
--

LOCK TABLES `male_rakutens` WRITE;
/*!40000 ALTER TABLE `male_rakutens` DISABLE KEYS */;
/*!40000 ALTER TABLE `male_rakutens` ENABLE KEYS */;
UNLOCK TABLES;
