...
--
-- Table structure for table `agent_mail_send`
--

DROP TABLE IF EXISTS `agent_mail_send`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `agent_mail_send` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `agent_mail_id` int(11) NOT NULL,
...
--
-- Dumping data for table `agent_mail_send`
--

LOCK TABLES `agent_mail_send` WRITE;
/*!40000 ALTER TABLE `agent_mail_send` DISABLE KEYS */;
/*!40000 ALTER TABLE `agent_mail_send` ENABLE KEYS */;
UNLOCK TABLES;
