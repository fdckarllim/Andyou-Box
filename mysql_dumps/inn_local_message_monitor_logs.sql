...
--
-- Table structure for table `message_monitor_logs`
--

DROP TABLE IF EXISTS `message_monitor_logs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `message_monitor_logs` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `message_id` int(11) NOT NULL,
  `monitor_type` varchar(255) COLLATE utf8mb4_bin NOT NULL,
...
--
-- Dumping data for table `message_monitor_logs`
--

LOCK TABLES `message_monitor_logs` WRITE;
/*!40000 ALTER TABLE `message_monitor_logs` DISABLE KEYS */;
/*!40000 ALTER TABLE `message_monitor_logs` ENABLE KEYS */;
UNLOCK TABLES;
