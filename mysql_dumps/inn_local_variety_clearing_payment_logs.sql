...
--
-- Table structure for table `variety_clearing_payment_logs`
--

DROP TABLE IF EXISTS `variety_clearing_payment_logs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `variety_clearing_payment_logs` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `period` int(11) NOT NULL,
  `approved_at` datetime DEFAULT NULL,
  `variety_eventer_id` int(11) DEFAULT NULL,
  `variety_production_id` int(11) DEFAULT NULL,
  `private_office_talent_id` int(11) DEFAULT NULL,
  ...
  `payment_status` varchar(255) COLLATE utf8mb4_bin NOT NULL DEFAULT 'process',
...
--
-- Dumping data for table `variety_clearing_payment_logs`
--

LOCK TABLES `variety_clearing_payment_logs` WRITE;
/*!40000 ALTER TABLE `variety_clearing_payment_logs` DISABLE KEYS */;
/*!40000 ALTER TABLE `variety_clearing_payment_logs` ENABLE KEYS */;
UNLOCK TABLES;
