...
--
-- Table structure for table `variety_event_dlc_buy_goods`
--

DROP TABLE IF EXISTS `variety_event_dlc_buy_goods`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `variety_event_dlc_buy_goods` (
  ...
  `request` text COLLATE utf8mb4_bin,
...
--
-- Dumping data for table `variety_event_dlc_buy_goods`
--

LOCK TABLES `variety_event_dlc_buy_goods` WRITE;
/*!40000 ALTER TABLE `variety_event_dlc_buy_goods` DISABLE KEYS */;
/*!40000 ALTER TABLE `variety_event_dlc_buy_goods` ENABLE KEYS */;
UNLOCK TABLES;
