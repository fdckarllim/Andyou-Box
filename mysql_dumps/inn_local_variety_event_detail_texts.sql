...
--
-- Table structure for table `variety_event_detail_texts`
--

DROP TABLE IF EXISTS `variety_event_detail_texts`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `variety_event_detail_texts` (
...
--
-- Dumping data for table `variety_event_detail_texts`
--

LOCK TABLES `variety_event_detail_texts` WRITE;
/*!40000 ALTER TABLE `variety_event_detail_texts` DISABLE KEYS */;
/*!40000 ALTER TABLE `variety_event_detail_texts` ENABLE KEYS */;
UNLOCK TABLES;
