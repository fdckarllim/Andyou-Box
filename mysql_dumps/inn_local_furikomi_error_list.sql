...
--
-- Table structure for table `furikomi_error_list`
--

DROP TABLE IF EXISTS `furikomi_error_list`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `furikomi_error_list` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `service_id` int(11) NOT NULL,
  `login_id` varchar(255) COLLATE utf8mb4_bin NOT NULL,
  `bank_category` varchar(255) COLLATE utf8mb4_bin NOT NULL,
  `transfer_account` varchar(255) COLLATE utf8mb4_bin NOT NULL,
  `money` varchar(255) COLLATE utf8mb4_bin NOT NULL,
...
--
-- Dumping data for table `furikomi_error_list`
--

LOCK TABLES `furikomi_error_list` WRITE;
/*!40000 ALTER TABLE `furikomi_error_list` DISABLE KEYS */;
/*!40000 ALTER TABLE `furikomi_error_list` ENABLE KEYS */;
UNLOCK TABLES;
