...
--
-- Table structure for table `variety_mobile_push_token_android`
--

DROP TABLE IF EXISTS `variety_mobile_push_token_android`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `variety_mobile_push_token_android` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token_id` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL,
  `not_read_count` int(11) NOT NULL DEFAULT '0',
  ...
  `male_member_id` int(11) DEFAULT '0' COMMENT 'ユーザid',
  PRIMARY KEY (`id`),
  KEY `idx_token_id` (`token_id`(191))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `variety_mobile_push_token_android`
--

LOCK TABLES `variety_mobile_push_token_android` WRITE;
/*!40000 ALTER TABLE `variety_mobile_push_token_android` DISABLE KEYS */;
/*!40000 ALTER TABLE `variety_mobile_push_token_android` ENABLE KEYS */;
UNLOCK TABLES;
