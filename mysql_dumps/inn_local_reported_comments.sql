...
CREATE TABLE `reported_comments` (
  ...
  `text_chat_log_id` int(11) NOT NULL,
  `reporter_type` varchar(255) COLLATE utf8mb4_bin NOT NULL,
  `report_female_member_id` int(11) DEFAULT NULL,
  `report_male_member_id` int(11) DEFAULT NULL,
  `report_anonymous_user_id` int(11) DEFAULT NULL,
