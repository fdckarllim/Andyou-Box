...
--
-- Table structure for table `variety_event_broadcast_ticket_logs`
--

DROP TABLE IF EXISTS `variety_event_broadcast_ticket_logs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `variety_event_broadcast_ticket_logs` (
...
--
-- Dumping data for table `variety_event_broadcast_ticket_logs`
--

LOCK TABLES `variety_event_broadcast_ticket_logs` WRITE;
/*!40000 ALTER TABLE `variety_event_broadcast_ticket_logs` DISABLE KEYS */;
/*!40000 ALTER TABLE `variety_event_broadcast_ticket_logs` ENABLE KEYS */;
UNLOCK TABLES;
