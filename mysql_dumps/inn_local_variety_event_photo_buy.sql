...
--
-- Table structure for table `variety_event_photo_buy`
--

DROP TABLE IF EXISTS `variety_event_photo_buy`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `variety_event_photo_buy` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `variety_event_photo_send_id` int(11) NOT NULL,
  ...
  `append` text COLLATE utf8mb4_bin NOT NULL,
...
--
-- Dumping data for table `variety_event_photo_buy`
--

LOCK TABLES `variety_event_photo_buy` WRITE;
/*!40000 ALTER TABLE `variety_event_photo_buy` DISABLE KEYS */;
/*!40000 ALTER TABLE `variety_event_photo_buy` ENABLE KEYS */;
UNLOCK TABLES;
