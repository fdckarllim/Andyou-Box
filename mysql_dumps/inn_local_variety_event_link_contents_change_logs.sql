...
--
-- Table structure for table `variety_event_link_contents_change_logs`
--

DROP TABLE IF EXISTS `variety_event_link_contents_change_logs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `variety_event_link_contents_change_logs` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `variety_event_link_contents_id` int(11) NOT NULL,
...
--
-- Dumping data for table `variety_event_link_contents_change_logs`
--

LOCK TABLES `variety_event_link_contents_change_logs` WRITE;
/*!40000 ALTER TABLE `variety_event_link_contents_change_logs` DISABLE KEYS */;
/*!40000 ALTER TABLE `variety_event_link_contents_change_logs` ENABLE KEYS */;
UNLOCK TABLES;
