...
--
-- Table structure for table `performer_monthly_ranks`
--

DROP TABLE IF EXISTS `performer_monthly_ranks`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `performer_monthly_ranks` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `female_member_id` int(11) NOT NULL,
  `date` date NOT NULL,
  `performer_rank_id` int(11) NOT NULL,
  `get_coin` bigint(20) NOT NULL DEFAULT '0',
  `counting_from` datetime NOT NULL,
  `counting_to` datetime NOT NULL,
...
--
-- Dumping data for table `performer_monthly_ranks`
--

LOCK TABLES `performer_monthly_ranks` WRITE;
/*!40000 ALTER TABLE `performer_monthly_ranks` DISABLE KEYS */;
/*!40000 ALTER TABLE `performer_monthly_ranks` ENABLE KEYS */;
UNLOCK TABLES;
