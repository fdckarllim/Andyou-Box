...
--
-- Table structure for table `reported_performers`
--

DROP TABLE IF EXISTS `reported_performers`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `reported_performers` (
...
--
-- Dumping data for table `reported_performers`
--

LOCK TABLES `reported_performers` WRITE;
/*!40000 ALTER TABLE `reported_performers` DISABLE KEYS */;
/*!40000 ALTER TABLE `reported_performers` ENABLE KEYS */;
UNLOCK TABLES;
