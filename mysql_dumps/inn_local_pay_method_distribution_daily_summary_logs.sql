...
--
-- Table structure for table `pay_method_distribution_daily_summary_logs`
--

DROP TABLE IF EXISTS `pay_method_distribution_daily_summary_logs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `pay_method_distribution_daily_summary_logs` (
...
--
-- Dumping data for table `pay_method_distribution_daily_summary_logs`
--

LOCK TABLES `pay_method_distribution_daily_summary_logs` WRITE;
/*!40000 ALTER TABLE `pay_method_distribution_daily_summary_logs` DISABLE KEYS */;
/*!40000 ALTER TABLE `pay_method_distribution_daily_summary_logs` ENABLE KEYS */;
UNLOCK TABLES;
