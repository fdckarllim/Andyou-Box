...
--
-- Table structure for table `unit_talents`
--

DROP TABLE IF EXISTS `unit_talents`;
...
CREATE TABLE `unit_talents` (
  ...
  `talent_private_office_flag` tinyint(1) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `unit_talents`
--

LOCK TABLES `unit_talents` WRITE;
/*!40000 ALTER TABLE `unit_talents` DISABLE KEYS */;
/*!40000 ALTER TABLE `unit_talents` ENABLE KEYS */;
UNLOCK TABLES;
