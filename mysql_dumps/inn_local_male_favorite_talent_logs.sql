...
--
-- Table structure for table `male_favorite_talent_logs`
--

DROP TABLE IF EXISTS `male_favorite_talent_logs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `male_favorite_talent_logs` (
...
--
-- Dumping data for table `male_favorite_talent_logs`
--

LOCK TABLES `male_favorite_talent_logs` WRITE;
/*!40000 ALTER TABLE `male_favorite_talent_logs` DISABLE KEYS */;
/*!40000 ALTER TABLE `male_favorite_talent_logs` ENABLE KEYS */;
UNLOCK TABLES;
