...
--
-- Table structure for table `challenging_logs`
--

DROP TABLE IF EXISTS `challenging_logs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `challenging_logs` (
  ...
  `total_get_coin` int(11) NOT NULL DEFAULT '0',
  `before_rank` varchar(255) COLLATE utf8mb4_bin NOT NULL,
  `after_rank` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL,
...
--
-- Dumping data for table `challenging_logs`
--

LOCK TABLES `challenging_logs` WRITE;
/*!40000 ALTER TABLE `challenging_logs` DISABLE KEYS */;
/*!40000 ALTER TABLE `challenging_logs` ENABLE KEYS */;
UNLOCK TABLES;
