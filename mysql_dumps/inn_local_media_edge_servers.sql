...
--
-- Table structure for table `media_edge_servers`
--

DROP TABLE IF EXISTS `media_edge_servers`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `media_edge_servers` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL,
  `origin_server_id` int(11) NOT NULL,
...
--
-- Dumping data for table `media_edge_servers`
--

LOCK TABLES `media_edge_servers` WRITE;
/*!40000 ALTER TABLE `media_edge_servers` DISABLE KEYS */;
/*!40000 ALTER TABLE `media_edge_servers` ENABLE KEYS */;
UNLOCK TABLES;
