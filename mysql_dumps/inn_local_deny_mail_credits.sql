...
--
-- Table structure for table `deny_mail_credits`
--

DROP TABLE IF EXISTS `deny_mail_credits`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `deny_mail_credits` (
...
--
-- Dumping data for table `deny_mail_credits`
--

LOCK TABLES `deny_mail_credits` WRITE;
/*!40000 ALTER TABLE `deny_mail_credits` DISABLE KEYS */;
/*!40000 ALTER TABLE `deny_mail_credits` ENABLE KEYS */;
UNLOCK TABLES;
