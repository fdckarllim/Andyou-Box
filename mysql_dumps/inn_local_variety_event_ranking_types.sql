...
--
-- Table structure for table `variety_event_ranking_types`
--

DROP TABLE IF EXISTS `variety_event_ranking_types`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `variety_event_ranking_types` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `variety_event_ranking_department_id` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL,
  `description` text COLLATE utf8mb4_bin,
  `display_rank` int(11) DEFAULT NULL,
  `rank_report_flag` tinyint(1) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `variety_event_ranking_types`
--

LOCK TABLES `variety_event_ranking_types` WRITE;
/*!40000 ALTER TABLE `variety_event_ranking_types` DISABLE KEYS */;
/*!40000 ALTER TABLE `variety_event_ranking_types` ENABLE KEYS */;
UNLOCK TABLES;
