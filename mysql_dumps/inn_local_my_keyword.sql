...
--
-- Table structure for table `my_keyword`
--

DROP TABLE IF EXISTS `my_keyword`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `my_keyword` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `male_member_id` int(11) NOT NULL,
  `my_keyword1` varchar(255) COLLATE utf8mb4_bin NOT NULL,
  `my_keyword2` varchar(255) COLLATE utf8mb4_bin NOT NULL,
  `my_keyword3` varchar(255) COLLATE utf8mb4_bin NOT NULL,
...
--
-- Dumping data for table `my_keyword`
--

LOCK TABLES `my_keyword` WRITE;
/*!40000 ALTER TABLE `my_keyword` DISABLE KEYS */;
/*!40000 ALTER TABLE `my_keyword` ENABLE KEYS */;
UNLOCK TABLES;
