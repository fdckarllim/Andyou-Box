...
--
-- Table structure for table `variety_event_grandprix_entries`
--

DROP TABLE IF EXISTS `variety_event_grandprix_entries`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `variety_event_grandprix_entries` (
  ...
  `image_caption` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL,
...
--
-- Dumping data for table `variety_event_grandprix_entries`
--

LOCK TABLES `variety_event_grandprix_entries` WRITE;
/*!40000 ALTER TABLE `variety_event_grandprix_entries` DISABLE KEYS */;
/*!40000 ALTER TABLE `variety_event_grandprix_entries` ENABLE KEYS */;
UNLOCK TABLES;
