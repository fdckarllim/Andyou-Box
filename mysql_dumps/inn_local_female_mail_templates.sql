...
--
-- Table structure for table `female_mail_templates`
--

DROP TABLE IF EXISTS `female_mail_templates`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `female_mail_templates` (
...
--
-- Dumping data for table `female_mail_templates`
--

LOCK TABLES `female_mail_templates` WRITE;
/*!40000 ALTER TABLE `female_mail_templates` DISABLE KEYS */;
/*!40000 ALTER TABLE `female_mail_templates` ENABLE KEYS */;
UNLOCK TABLES;
