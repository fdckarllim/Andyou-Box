...
--
-- Table structure for table `heartmark_logs`
--

DROP TABLE IF EXISTS `heartmark_logs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `heartmark_logs` (
...
--
-- Dumping data for table `heartmark_logs`
--

LOCK TABLES `heartmark_logs` WRITE;
/*!40000 ALTER TABLE `heartmark_logs` DISABLE KEYS */;
/*!40000 ALTER TABLE `heartmark_logs` ENABLE KEYS */;
UNLOCK TABLES;
