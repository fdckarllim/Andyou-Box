...
--
-- Table structure for table `variety_download_photo_buy_logs`
--

DROP TABLE IF EXISTS `variety_download_photo_buy_logs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `variety_download_photo_buy_logs` (
...
--
-- Dumping data for table `variety_download_photo_buy_logs`
--

LOCK TABLES `variety_download_photo_buy_logs` WRITE;
/*!40000 ALTER TABLE `variety_download_photo_buy_logs` DISABLE KEYS */;
/*!40000 ALTER TABLE `variety_download_photo_buy_logs` ENABLE KEYS */;
UNLOCK TABLES;
