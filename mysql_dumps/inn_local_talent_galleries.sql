...
--
-- Table structure for table `talent_galleries`
--

DROP TABLE IF EXISTS `talent_galleries`;
...
--
-- Dumping data for table `talent_galleries`
--

LOCK TABLES `talent_galleries` WRITE;
/*!40000 ALTER TABLE `talent_galleries` DISABLE KEYS */;
/*!40000 ALTER TABLE `talent_galleries` ENABLE KEYS */;
UNLOCK TABLES;
