...
--
-- Table structure for table `variety_free_point_bonus_logs`
--

DROP TABLE IF EXISTS `variety_free_point_bonus_logs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `variety_free_point_bonus_logs` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `male_member_id` int(11) NOT NULL,
  `grant_date` varchar(255) COLLATE utf8mb4_bin NOT NULL,
  `bonus_type` varchar(255) COLLATE utf8mb4_bin NOT NULL,
  `variety_event_broadcast_id` int(11) DEFAULT NULL,
  `variety_event_performer_id` int(11) DEFAULT NULL,
  `variety_chat_room_id` int(11) DEFAULT NULL,
  `point` int(11) NOT NULL,
  `male_virtual_money_log_id` int(11) NOT NULL,
...
--
-- Dumping data for table `variety_free_point_bonus_logs`
--

LOCK TABLES `variety_free_point_bonus_logs` WRITE;
/*!40000 ALTER TABLE `variety_free_point_bonus_logs` DISABLE KEYS */;
/*!40000 ALTER TABLE `variety_free_point_bonus_logs` ENABLE KEYS */;
UNLOCK TABLES;
