...
--
-- Table structure for table `performer_daily_summary_access_logs`
--

DROP TABLE IF EXISTS `performer_daily_summary_access_logs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `performer_daily_summary_access_logs` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `date` date NOT NULL,
  `is_agent_performer` tinyint(1) NOT NULL DEFAULT '0',
  `loggedin_count` int(11) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `performer_daily_summary_access_logs`
--

LOCK TABLES `performer_daily_summary_access_logs` WRITE;
/*!40000 ALTER TABLE `performer_daily_summary_access_logs` DISABLE KEYS */;
/*!40000 ALTER TABLE `performer_daily_summary_access_logs` ENABLE KEYS */;
UNLOCK TABLES;
