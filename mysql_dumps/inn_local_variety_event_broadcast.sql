...
--
-- Table structure for table `variety_event_broadcast`
--

DROP TABLE IF EXISTS `variety_event_broadcast`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `variety_event_broadcast` (
...
--
-- Dumping data for table `variety_event_broadcast`
--

LOCK TABLES `variety_event_broadcast` WRITE;
/*!40000 ALTER TABLE `variety_event_broadcast` DISABLE KEYS */;
/*!40000 ALTER TABLE `variety_event_broadcast` ENABLE KEYS */;
UNLOCK TABLES;
