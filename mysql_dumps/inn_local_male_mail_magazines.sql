...
--
-- Table structure for table `male_mail_magazines`
--

DROP TABLE IF EXISTS `male_mail_magazines`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `male_mail_magazines` (
...
--
-- Dumping data for table `male_mail_magazines`
--

LOCK TABLES `male_mail_magazines` WRITE;
/*!40000 ALTER TABLE `male_mail_magazines` DISABLE KEYS */;
/*!40000 ALTER TABLE `male_mail_magazines` ENABLE KEYS */;
UNLOCK TABLES;
