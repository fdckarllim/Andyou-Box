...
--
-- Table structure for table `macherie_blog_apply_logs`
--

DROP TABLE IF EXISTS `macherie_blog_apply_logs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `macherie_blog_apply_logs` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `female_member_id` int(11) NOT NULL,
  `macherie_blog_reward_id` int(11) NOT NULL,
  `url` varchar(1023) COLLATE utf8mb4_bin NOT NULL,
  `result` varchar(255) COLLATE utf8mb4_bin NOT NULL,
  `ng_reason` text COLLATE utf8mb4_bin,
  ...
  KEY `idx_macherie_blog_reward_id` (`macherie_blog_reward_id`),
  KEY `idx_female_point_log_id` (`female_point_log_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `macherie_blog_apply_logs`
--

LOCK TABLES `macherie_blog_apply_logs` WRITE;
/*!40000 ALTER TABLE `macherie_blog_apply_logs` DISABLE KEYS */;
/*!40000 ALTER TABLE `macherie_blog_apply_logs` ENABLE KEYS */;
UNLOCK TABLES;
