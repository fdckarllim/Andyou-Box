...
--
-- Table structure for table `female_member_blacklists`
--

DROP TABLE IF EXISTS `female_member_blacklists`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `female_member_blacklists` (
  ...
  `bank_meigi` text COLLATE utf8mb4_bin,
...
--
-- Dumping data for table `female_member_blacklists`
--

LOCK TABLES `female_member_blacklists` WRITE;
/*!40000 ALTER TABLE `female_member_blacklists` DISABLE KEYS */;
/*!40000 ALTER TABLE `female_member_blacklists` ENABLE KEYS */;
UNLOCK TABLES;
