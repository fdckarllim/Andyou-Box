...
--
-- Table structure for table `variety_download_photo_performers`
--

DROP TABLE IF EXISTS `variety_download_photo_performers`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `variety_download_photo_performers` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `variety_event_id` int(11) NOT NULL,
  `variety_event_performer_id` int(11) NOT NULL,
  `variety_production_id` int(11) NOT NULL,
  `supervision_limit_date` datetime DEFAULT NULL,
  `publish_from` datetime DEFAULT NULL,
  `publish_to` datetime DEFAULT NULL,
  `status` varchar(255) COLLATE utf8mb4_bin NOT NULL DEFAULT 'registering',
...
--
-- Dumping data for table `variety_download_photo_performers`
--

LOCK TABLES `variety_download_photo_performers` WRITE;
/*!40000 ALTER TABLE `variety_download_photo_performers` DISABLE KEYS */;
/*!40000 ALTER TABLE `variety_download_photo_performers` ENABLE KEYS */;
UNLOCK TABLES;
