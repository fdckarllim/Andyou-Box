...
--
-- Table structure for table `variety_event_cours_ranking_detail`
--

DROP TABLE IF EXISTS `variety_event_cours_ranking_detail`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `variety_event_cours_ranking_detail` (
...
--
-- Dumping data for table `variety_event_cours_ranking_detail`
--

LOCK TABLES `variety_event_cours_ranking_detail` WRITE;
/*!40000 ALTER TABLE `variety_event_cours_ranking_detail` DISABLE KEYS */;
/*!40000 ALTER TABLE `variety_event_cours_ranking_detail` ENABLE KEYS */;
UNLOCK TABLES;
