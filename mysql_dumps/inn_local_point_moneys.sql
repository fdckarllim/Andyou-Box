...
--
-- Table structure for table `point_moneys`
--

DROP TABLE IF EXISTS `point_moneys`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `point_moneys` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `service_id` int(11) NOT NULL,
  `pay_method` varchar(255) COLLATE utf8mb4_bin NOT NULL,
  `priority` int(11) NOT NULL DEFAULT '1',
  `money` int(11) NOT NULL,
  `vip_point` bigint(50) NOT NULL DEFAULT '0',
  `point` bigint(50) NOT NULL DEFAULT '0',
  `service_point` bigint(50) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `point_moneys`
--

LOCK TABLES `point_moneys` WRITE;
/*!40000 ALTER TABLE `point_moneys` DISABLE KEYS */;
/*!40000 ALTER TABLE `point_moneys` ENABLE KEYS */;
UNLOCK TABLES;
