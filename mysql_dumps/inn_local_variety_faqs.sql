...
--
-- Table structure for table `variety_faqs`
--

DROP TABLE IF EXISTS `variety_faqs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `variety_faqs` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `variety_faq_category_id` int(11) NOT NULL,
  ...
  `show_flag_pc` tinyint(1) NOT NULL DEFAULT '1',
  `show_flag_sp` tinyint(1) NOT NULL DEFAULT '1',
  `mode` varchar(255) COLLATE utf8mb4_bin NOT NULL,
  `show_flag` tinyint(1) NOT NULL DEFAULT '0',
  `web_display_flag` tinyint(1) NOT NULL DEFAULT '1',
  `sp_android_display_flag` tinyint(1) NOT NULL DEFAULT '0',
  `sp_ios_display_flag` tinyint(1) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `variety_faqs`
--

LOCK TABLES `variety_faqs` WRITE;
/*!40000 ALTER TABLE `variety_faqs` DISABLE KEYS */;
/*!40000 ALTER TABLE `variety_faqs` ENABLE KEYS */;
UNLOCK TABLES;
