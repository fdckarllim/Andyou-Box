...
--
-- Table structure for table `performer_identity_verification_logs`
--

DROP TABLE IF EXISTS `performer_identity_verification_logs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `performer_identity_verification_logs` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `female_member_id` int(11) NOT NULL,
  `result` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL,
  `ng_reason` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL,
...
--
-- Dumping data for table `performer_identity_verification_logs`
--

LOCK TABLES `performer_identity_verification_logs` WRITE;
/*!40000 ALTER TABLE `performer_identity_verification_logs` DISABLE KEYS */;
/*!40000 ALTER TABLE `performer_identity_verification_logs` ENABLE KEYS */;
UNLOCK TABLES;
