...
--
-- Table structure for table `male_favorite_unit_logs`
--

DROP TABLE IF EXISTS `male_favorite_unit_logs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `male_favorite_unit_logs` (
...
--
-- Dumping data for table `male_favorite_unit_logs`
--

LOCK TABLES `male_favorite_unit_logs` WRITE;
/*!40000 ALTER TABLE `male_favorite_unit_logs` DISABLE KEYS */;
/*!40000 ALTER TABLE `male_favorite_unit_logs` ENABLE KEYS */;
UNLOCK TABLES;
