...
--
-- Table structure for table `male_address_books`
--

DROP TABLE IF EXISTS `male_address_books`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `male_address_books` (
...
--
-- Dumping data for table `male_address_books`
--

LOCK TABLES `male_address_books` WRITE;
/*!40000 ALTER TABLE `male_address_books` DISABLE KEYS */;
/*!40000 ALTER TABLE `male_address_books` ENABLE KEYS */;
UNLOCK TABLES;
