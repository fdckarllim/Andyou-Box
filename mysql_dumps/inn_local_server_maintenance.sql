...
DROP TABLE IF EXISTS `server_maintenance`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `server_maintenance` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `status` varchar(255) COLLATE utf8mb4_bin NOT NULL DEFAULT 'site_open',
...
--
-- Dumping data for table `server_maintenance`
--

LOCK TABLES `server_maintenance` WRITE;
