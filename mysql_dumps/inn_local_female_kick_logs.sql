...
--
-- Table structure for table `female_kick_logs`
--

DROP TABLE IF EXISTS `female_kick_logs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `female_kick_logs` (
...
--
-- Dumping data for table `female_kick_logs`
--

LOCK TABLES `female_kick_logs` WRITE;
/*!40000 ALTER TABLE `female_kick_logs` DISABLE KEYS */;
/*!40000 ALTER TABLE `female_kick_logs` ENABLE KEYS */;
UNLOCK TABLES;
