...
--
-- Table structure for table `chat_room_waiting_peep_logs`
--

DROP TABLE IF EXISTS `chat_room_waiting_peep_logs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `chat_room_waiting_peep_logs` (
...
--
-- Dumping data for table `chat_room_waiting_peep_logs`
--

LOCK TABLES `chat_room_waiting_peep_logs` WRITE;
/*!40000 ALTER TABLE `chat_room_waiting_peep_logs` DISABLE KEYS */;
/*!40000 ALTER TABLE `chat_room_waiting_peep_logs` ENABLE KEYS */;
UNLOCK TABLES;
