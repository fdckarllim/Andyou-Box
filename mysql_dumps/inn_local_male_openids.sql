...
--
-- Table structure for table `male_openids`
--

DROP TABLE IF EXISTS `male_openids`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `male_openids` (
...
--
-- Dumping data for table `male_openids`
--

LOCK TABLES `male_openids` WRITE;
/*!40000 ALTER TABLE `male_openids` DISABLE KEYS */;
/*!40000 ALTER TABLE `male_openids` ENABLE KEYS */;
UNLOCK TABLES;
