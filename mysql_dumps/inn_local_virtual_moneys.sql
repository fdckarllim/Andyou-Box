...
--
-- Table structure for table `virtual_moneys`
--

DROP TABLE IF EXISTS `virtual_moneys`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `virtual_moneys` (
...
--
-- Dumping data for table `virtual_moneys`
--

LOCK TABLES `virtual_moneys` WRITE;
/*!40000 ALTER TABLE `virtual_moneys` DISABLE KEYS */;
/*!40000 ALTER TABLE `virtual_moneys` ENABLE KEYS */;
UNLOCK TABLES;
