...
--
-- Table structure for table `campaign_dig_user_codes`
--

DROP TABLE IF EXISTS `campaign_dig_user_codes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `campaign_dig_user_codes` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `service_id` int(11) NOT NULL,
  `code` varchar(255) COLLATE utf8mb4_bin NOT NULL,
  `receivable_from` datetime NOT NULL,
  `receivable_to` datetime NOT NULL,
...
--
-- Dumping data for table `campaign_dig_user_codes`
--

LOCK TABLES `campaign_dig_user_codes` WRITE;
/*!40000 ALTER TABLE `campaign_dig_user_codes` DISABLE KEYS */;
/*!40000 ALTER TABLE `campaign_dig_user_codes` ENABLE KEYS */;
UNLOCK TABLES;
