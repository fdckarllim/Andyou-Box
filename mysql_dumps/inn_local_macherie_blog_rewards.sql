...
--
-- Table structure for table `macherie_blog_rewards`
--

DROP TABLE IF EXISTS `macherie_blog_rewards`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `macherie_blog_rewards` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `thema` varchar(255) COLLATE utf8mb4_bin NOT NULL,
  `date_from` datetime NOT NULL,
  `date_to` datetime NOT NULL,
  `min_characters` int(11) NOT NULL,
...
--
-- Dumping data for table `macherie_blog_rewards`
--

LOCK TABLES `macherie_blog_rewards` WRITE;
/*!40000 ALTER TABLE `macherie_blog_rewards` DISABLE KEYS */;
/*!40000 ALTER TABLE `macherie_blog_rewards` ENABLE KEYS */;
UNLOCK TABLES;
