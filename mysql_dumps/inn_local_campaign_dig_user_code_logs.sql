...
--
-- Table structure for table `campaign_dig_user_code_logs`
--

DROP TABLE IF EXISTS `campaign_dig_user_code_logs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `campaign_dig_user_code_logs` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `male_member_id` int(11) NOT NULL,
  `code` varchar(255) COLLATE utf8mb4_bin NOT NULL,
  `posted_at` datetime NOT NULL,
  `got_at` datetime DEFAULT NULL,
...
--
-- Dumping data for table `campaign_dig_user_code_logs`
--

LOCK TABLES `campaign_dig_user_code_logs` WRITE;
/*!40000 ALTER TABLE `campaign_dig_user_code_logs` DISABLE KEYS */;
/*!40000 ALTER TABLE `campaign_dig_user_code_logs` ENABLE KEYS */;
UNLOCK TABLES;
