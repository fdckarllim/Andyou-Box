...
--
-- Table structure for table `server_maintenance_log`
--

DROP TABLE IF EXISTS `server_maintenance_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `server_maintenance_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `before_status` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL,
  `after_status` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL,
...
--
-- Dumping data for table `server_maintenance_log`
--

LOCK TABLES `server_maintenance_log` WRITE;
/*!40000 ALTER TABLE `server_maintenance_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `server_maintenance_log` ENABLE KEYS */;
UNLOCK TABLES;
