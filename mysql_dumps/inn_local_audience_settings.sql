...
--
-- Table structure for table `audience_settings`
--

DROP TABLE IF EXISTS `audience_settings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `audience_settings` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `assortment` varchar(255) COLLATE utf8mb4_bin NOT NULL,
  `chat_mode` varchar(255) COLLATE utf8mb4_bin NOT NULL,
  `connect_num` int(11) NOT NULL,
  `view_sec` int(11) NOT NULL,
...
--
-- Dumping data for table `audience_settings`
--

LOCK TABLES `audience_settings` WRITE;
/*!40000 ALTER TABLE `audience_settings` DISABLE KEYS */;
/*!40000 ALTER TABLE `audience_settings` ENABLE KEYS */;
UNLOCK TABLES;
