...
--
-- Table structure for table `male_mails`
--

DROP TABLE IF EXISTS `male_mails`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `male_mails` (
...
--
-- Dumping data for table `male_mails`
--

LOCK TABLES `male_mails` WRITE;
/*!40000 ALTER TABLE `male_mails` DISABLE KEYS */;
/*!40000 ALTER TABLE `male_mails` ENABLE KEYS */;
UNLOCK TABLES;
