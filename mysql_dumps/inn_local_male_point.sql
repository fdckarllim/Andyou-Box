...
--
-- Table structure for table `male_point`
--

DROP TABLE IF EXISTS `male_point`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `male_point` (
...
--
-- Dumping data for table `male_point`
--

LOCK TABLES `male_point` WRITE;
/*!40000 ALTER TABLE `male_point` DISABLE KEYS */;
/*!40000 ALTER TABLE `male_point` ENABLE KEYS */;
UNLOCK TABLES;
