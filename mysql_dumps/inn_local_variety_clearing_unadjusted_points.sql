...
--
-- Table structure for table `variety_clearing_unadjusted_points`
--

DROP TABLE IF EXISTS `variety_clearing_unadjusted_points`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `variety_clearing_unadjusted_points` (
  ...
  `unadjusted_point` bigint(20) NOT NULL,
...
--
-- Dumping data for table `variety_clearing_unadjusted_points`
--

LOCK TABLES `variety_clearing_unadjusted_points` WRITE;
/*!40000 ALTER TABLE `variety_clearing_unadjusted_points` DISABLE KEYS */;
/*!40000 ALTER TABLE `variety_clearing_unadjusted_points` ENABLE KEYS */;
UNLOCK TABLES;
