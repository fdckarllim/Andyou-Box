...
--
-- Table structure for table `variety_chat_room_anonymous_users`
--

DROP TABLE IF EXISTS `variety_chat_room_anonymous_users`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `variety_chat_room_anonymous_users` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `service_id` int(11) NOT NULL,
  `room_id` varchar(255) COLLATE utf8mb4_bin NOT NULL,
  `variety_chat_room_id` int(11) DEFAULT NULL,
  `variety_anonymous_user_id` bigint(20) NOT NULL,
...
--
-- Dumping data for table `variety_chat_room_anonymous_users`
--

LOCK TABLES `variety_chat_room_anonymous_users` WRITE;
/*!40000 ALTER TABLE `variety_chat_room_anonymous_users` DISABLE KEYS */;
/*!40000 ALTER TABLE `variety_chat_room_anonymous_users` ENABLE KEYS */;
UNLOCK TABLES;
