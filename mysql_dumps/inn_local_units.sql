...
CREATE TABLE `units` (
  ...
  `unit_code` varchar(255) COLLATE utf8mb4_bin NOT NULL,
  ...
  `formed_year` year(4) DEFAULT NULL,
  `description` text COLLATE utf8mb4_bin,
  `icon_image` int(11) DEFAULT NULL,
  `unit_image` int(11) DEFAULT NULL,
  `unit_image_a` int(11) DEFAULT NULL,
  `unit_image_b` int(11) DEFAULT NULL,
