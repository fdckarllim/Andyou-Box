...
--
-- Dumping data for table `blog_article_likes`
--

LOCK TABLES `blog_article_likes` WRITE;
/*!40000 ALTER TABLE `blog_article_likes` DISABLE KEYS */;
/*!40000 ALTER TABLE `blog_article_likes` ENABLE KEYS */;
UNLOCK TABLES;
