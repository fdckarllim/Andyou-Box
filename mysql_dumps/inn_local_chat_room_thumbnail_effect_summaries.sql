...
--
-- Table structure for table `chat_room_thumbnail_effect_summaries`
--

DROP TABLE IF EXISTS `chat_room_thumbnail_effect_summaries`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `chat_room_thumbnail_effect_summaries` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `chat_room_id` int(11) NOT NULL,
  `female_member_id` int(11) NOT NULL,
  `audience_count` int(11) NOT NULL,
  `audience_count_diff` int(11) NOT NULL,
...
--
-- Dumping data for table `chat_room_thumbnail_effect_summaries`
--

LOCK TABLES `chat_room_thumbnail_effect_summaries` WRITE;
/*!40000 ALTER TABLE `chat_room_thumbnail_effect_summaries` DISABLE KEYS */;
/*!40000 ALTER TABLE `chat_room_thumbnail_effect_summaries` ENABLE KEYS */;
UNLOCK TABLES;
