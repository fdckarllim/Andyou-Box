...
--
-- Table structure for table `variety_settlement_token`
--

DROP TABLE IF EXISTS `variety_settlement_token`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `variety_settlement_token` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `male_member_id` int(11) NOT NULL,
  `product_id` int(11) DEFAULT NULL,
  `settlement_token` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL,
...
--
-- Dumping data for table `variety_settlement_token`
--

LOCK TABLES `variety_settlement_token` WRITE;
/*!40000 ALTER TABLE `variety_settlement_token` DISABLE KEYS */;
/*!40000 ALTER TABLE `variety_settlement_token` ENABLE KEYS */;
UNLOCK TABLES;
