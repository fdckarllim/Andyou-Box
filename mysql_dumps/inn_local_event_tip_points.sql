...
--
-- Table structure for table `event_tip_points`
--

DROP TABLE IF EXISTS `event_tip_points`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `event_tip_points` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `event_id` int(11) NOT NULL,
  `tip_point_id` int(11) DEFAULT NULL,
...
--
-- Dumping data for table `event_tip_points`
--

LOCK TABLES `event_tip_points` WRITE;
/*!40000 ALTER TABLE `event_tip_points` DISABLE KEYS */;
/*!40000 ALTER TABLE `event_tip_points` ENABLE KEYS */;
UNLOCK TABLES;
