...
--
-- Table structure for table `point_multi_settings`
--

DROP TABLE IF EXISTS `point_multi_settings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `point_multi_settings` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `charge_type` varchar(255) COLLATE utf8mb4_bin NOT NULL,
  `member_type` varchar(255) COLLATE utf8mb4_bin NOT NULL,
  `male_lv1` varchar(255) COLLATE utf8mb4_bin NOT NULL,
...
--
-- Dumping data for table `point_multi_settings`
--

LOCK TABLES `point_multi_settings` WRITE;
/*!40000 ALTER TABLE `point_multi_settings` DISABLE KEYS */;
/*!40000 ALTER TABLE `point_multi_settings` ENABLE KEYS */;
UNLOCK TABLES;
