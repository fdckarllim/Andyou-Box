...
--
-- Table structure for table `point_money_rate_details`
--

DROP TABLE IF EXISTS `point_money_rate_details`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `point_money_rate_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `point_money_rate_id` int(11) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `idx_point_money_rate_id` (`point_money_rate_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `point_money_rate_details`
--

LOCK TABLES `point_money_rate_details` WRITE;
/*!40000 ALTER TABLE `point_money_rate_details` DISABLE KEYS */;
/*!40000 ALTER TABLE `point_money_rate_details` ENABLE KEYS */;
UNLOCK TABLES;
