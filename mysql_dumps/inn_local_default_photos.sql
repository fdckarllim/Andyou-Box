...
--
-- Table structure for table `default_photos`
--

DROP TABLE IF EXISTS `default_photos`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `default_photos` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(1023) COLLATE utf8mb4_bin NOT NULL,
...
--
-- Dumping data for table `default_photos`
--

LOCK TABLES `default_photos` WRITE;
/*!40000 ALTER TABLE `default_photos` DISABLE KEYS */;
/*!40000 ALTER TABLE `default_photos` ENABLE KEYS */;
UNLOCK TABLES;
