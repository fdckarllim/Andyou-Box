...
--
-- Table structure for table `deny_mails`
--

DROP TABLE IF EXISTS `deny_mails`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `deny_mails` (
...
--
-- Dumping data for table `deny_mails`
--

LOCK TABLES `deny_mails` WRITE;
/*!40000 ALTER TABLE `deny_mails` DISABLE KEYS */;
/*!40000 ALTER TABLE `deny_mails` ENABLE KEYS */;
UNLOCK TABLES;
