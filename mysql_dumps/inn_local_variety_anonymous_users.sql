...
--
-- Table structure for table `variety_anonymous_users`
--

DROP TABLE IF EXISTS `variety_anonymous_users`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `variety_anonymous_users` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_anonymous_key` (`anonymous_key`(191))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `variety_anonymous_users`
--

LOCK TABLES `variety_anonymous_users` WRITE;
/*!40000 ALTER TABLE `variety_anonymous_users` DISABLE KEYS */;
/*!40000 ALTER TABLE `variety_anonymous_users` ENABLE KEYS */;
UNLOCK TABLES;
