...
--
-- Table structure for table `variety_event_broadcast_schedules`
--

DROP TABLE IF EXISTS `variety_event_broadcast_schedules`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `variety_event_broadcast_schedules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `variety_event_performer_id` int(11) NOT NULL,
  `broadcast_name` varchar(255) COLLATE utf8mb4_bin NOT NULL,
...
--
-- Dumping data for table `variety_event_broadcast_schedules`
--

LOCK TABLES `variety_event_broadcast_schedules` WRITE;
/*!40000 ALTER TABLE `variety_event_broadcast_schedules` DISABLE KEYS */;
/*!40000 ALTER TABLE `variety_event_broadcast_schedules` ENABLE KEYS */;
UNLOCK TABLES;
