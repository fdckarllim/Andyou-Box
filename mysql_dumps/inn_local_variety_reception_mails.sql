...
--
-- Table structure for table `variety_reception_mails`
--

DROP TABLE IF EXISTS `variety_reception_mails`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `variety_reception_mails` (
  ...
  `admin_send_flag` tinyint(4) NOT NULL DEFAULT '0',
  `read_flag` tinyint(4) NOT NULL DEFAULT '0',
  `deleted_flag` tinyint(4) NOT NULL DEFAULT '0',
  `important_flag` tinyint(4) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `variety_reception_mails`
--

LOCK TABLES `variety_reception_mails` WRITE;
/*!40000 ALTER TABLE `variety_reception_mails` DISABLE KEYS */;
/*!40000 ALTER TABLE `variety_reception_mails` ENABLE KEYS */;
UNLOCK TABLES;
