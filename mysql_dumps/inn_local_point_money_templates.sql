...
--
-- Table structure for table `point_money_templates`
--

DROP TABLE IF EXISTS `point_money_templates`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `point_money_templates` (
...
--
-- Dumping data for table `point_money_templates`
--

LOCK TABLES `point_money_templates` WRITE;
/*!40000 ALTER TABLE `point_money_templates` DISABLE KEYS */;
/*!40000 ALTER TABLE `point_money_templates` ENABLE KEYS */;
UNLOCK TABLES;
