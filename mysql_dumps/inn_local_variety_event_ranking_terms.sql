...
--
-- Table structure for table `variety_event_ranking_terms`
--

DROP TABLE IF EXISTS `variety_event_ranking_terms`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `variety_event_ranking_terms` (
...
--
-- Dumping data for table `variety_event_ranking_terms`
--

LOCK TABLES `variety_event_ranking_terms` WRITE;
/*!40000 ALTER TABLE `variety_event_ranking_terms` DISABLE KEYS */;
/*!40000 ALTER TABLE `variety_event_ranking_terms` ENABLE KEYS */;
UNLOCK TABLES;
