...
--
-- Table structure for table `variety_event_group`
--

DROP TABLE IF EXISTS `variety_event_group`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `variety_event_group` (
...
--
-- Dumping data for table `variety_event_group`
--

LOCK TABLES `variety_event_group` WRITE;
/*!40000 ALTER TABLE `variety_event_group` DISABLE KEYS */;
/*!40000 ALTER TABLE `variety_event_group` ENABLE KEYS */;
UNLOCK TABLES;
