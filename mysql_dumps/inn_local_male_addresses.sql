...
--
-- Table structure for table `male_addresses`
--

DROP TABLE IF EXISTS `male_addresses`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `male_addresses` (
...
--
-- Dumping data for table `male_addresses`
--

LOCK TABLES `male_addresses` WRITE;
/*!40000 ALTER TABLE `male_addresses` DISABLE KEYS */;
/*!40000 ALTER TABLE `male_addresses` ENABLE KEYS */;
UNLOCK TABLES;
