...
--
-- Table structure for table `audience_count_daily_summary_logs`
--

DROP TABLE IF EXISTS `audience_count_daily_summary_logs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `audience_count_daily_summary_logs` (
...
--
-- Dumping data for table `audience_count_daily_summary_logs`
--

LOCK TABLES `audience_count_daily_summary_logs` WRITE;
/*!40000 ALTER TABLE `audience_count_daily_summary_logs` DISABLE KEYS */;
/*!40000 ALTER TABLE `audience_count_daily_summary_logs` ENABLE KEYS */;
UNLOCK TABLES;
