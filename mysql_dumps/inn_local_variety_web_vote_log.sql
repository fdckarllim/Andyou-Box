...
--
-- Table structure for table `variety_web_vote_log`
--

DROP TABLE IF EXISTS `variety_web_vote_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `variety_web_vote_log` (
...
--
-- Dumping data for table `variety_web_vote_log`
--

LOCK TABLES `variety_web_vote_log` WRITE;
/*!40000 ALTER TABLE `variety_web_vote_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `variety_web_vote_log` ENABLE KEYS */;
UNLOCK TABLES;
