...
--
-- Table structure for table `variety_production_staff`
--

DROP TABLE IF EXISTS `variety_production_staff`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `variety_production_staff` (
...
--
-- Dumping data for table `variety_production_staff`
--

LOCK TABLES `variety_production_staff` WRITE;
/*!40000 ALTER TABLE `variety_production_staff` DISABLE KEYS */;
INSERT INTO `variety_production_staff` VALUES (1,1,'testProductionA','','','','testPrdtionA','testPrdtionA','127.0.0.1','1','127.0.0.1','1','admin','admin',NULL,NULL,'2017-01-03 09:00:00',NULL);
/*!40000 ALTER TABLE `variety_production_staff` ENABLE KEYS */;
UNLOCK TABLES;
