...
--
-- Table structure for table `variety_event_broadcast_ticket_log`
--

DROP TABLE IF EXISTS `variety_event_broadcast_ticket_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `variety_event_broadcast_ticket_log` (
...
--
-- Dumping data for table `variety_event_broadcast_ticket_log`
--

LOCK TABLES `variety_event_broadcast_ticket_log` WRITE;
/*!40000 ALTER TABLE `variety_event_broadcast_ticket_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `variety_event_broadcast_ticket_log` ENABLE KEYS */;
UNLOCK TABLES;
