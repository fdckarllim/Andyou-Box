...
--
-- Table structure for table `talent_goods`
--

DROP TABLE IF EXISTS `talent_goods`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `talent_goods` (
...
--
-- Dumping data for table `talent_goods`
--

LOCK TABLES `talent_goods` WRITE;
/*!40000 ALTER TABLE `talent_goods` DISABLE KEYS */;
/*!40000 ALTER TABLE `talent_goods` ENABLE KEYS */;
UNLOCK TABLES;
