...
--
-- Table structure for table `female_login_logs`
--

DROP TABLE IF EXISTS `female_login_logs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `female_login_logs` (
...
--
-- Dumping data for table `female_login_logs`
--

LOCK TABLES `female_login_logs` WRITE;
/*!40000 ALTER TABLE `female_login_logs` DISABLE KEYS */;
/*!40000 ALTER TABLE `female_login_logs` ENABLE KEYS */;
UNLOCK TABLES;
