...
--
-- Table structure for table `male_point_log`
--

DROP TABLE IF EXISTS `male_point_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `male_point_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `service_group_id` int(11) NOT NULL,
  `male_member_id` int(11) NOT NULL,
  `point` decimal(9,1) NOT NULL DEFAULT '0.0',
  `point_old` decimal(9,1) NOT NULL DEFAULT '0.0',
  `change_type` varchar(255) COLLATE utf8mb4_bin NOT NULL,
...
--
-- Dumping data for table `male_point_log`
--

LOCK TABLES `male_point_log` WRITE;
/*!40000 ALTER TABLE `male_point_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `male_point_log` ENABLE KEYS */;
UNLOCK TABLES;
