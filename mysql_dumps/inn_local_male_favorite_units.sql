...
--
-- Table structure for table `male_favorite_units`
--

DROP TABLE IF EXISTS `male_favorite_units`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `male_favorite_units` (
...
--
-- Dumping data for table `male_favorite_units`
--

LOCK TABLES `male_favorite_units` WRITE;
/*!40000 ALTER TABLE `male_favorite_units` DISABLE KEYS */;
/*!40000 ALTER TABLE `male_favorite_units` ENABLE KEYS */;
UNLOCK TABLES;
