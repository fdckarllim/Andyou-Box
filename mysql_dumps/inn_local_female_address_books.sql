...
--
-- Table structure for table `female_address_books`
--

DROP TABLE IF EXISTS `female_address_books`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `female_address_books` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `service_id` int(11) NOT NULL,
  `female_member_id` int(11) NOT NULL,
  `male_member_id` int(11) NOT NULL,
  `memo` varchar(255) COLLATE utf8mb4_bin NOT NULL,
  `address_type` varchar(255) COLLATE utf8mb4_bin NOT NULL DEFAULT 'memo',
  `former_type` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL,
...
--
-- Dumping data for table `female_address_books`
--

LOCK TABLES `female_address_books` WRITE;
/*!40000 ALTER TABLE `female_address_books` DISABLE KEYS */;
/*!40000 ALTER TABLE `female_address_books` ENABLE KEYS */;
UNLOCK TABLES;
