...
--
-- Table structure for table `variety_event_external_links`
--

DROP TABLE IF EXISTS `variety_event_external_links`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `variety_event_external_links` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `variety_event_id` int(11) NOT NULL,
  `image_id` int(11) NOT NULL,
  `site_name` varchar(255) COLLATE utf8mb4_bin NOT NULL,
...
--
-- Dumping data for table `variety_event_external_links`
--

LOCK TABLES `variety_event_external_links` WRITE;
/*!40000 ALTER TABLE `variety_event_external_links` DISABLE KEYS */;
/*!40000 ALTER TABLE `variety_event_external_links` ENABLE KEYS */;
UNLOCK TABLES;
