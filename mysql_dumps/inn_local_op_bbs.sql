...
--
-- Table structure for table `op_bbs`
--

DROP TABLE IF EXISTS `op_bbs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `op_bbs` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `service_id` int(11) NOT NULL,
  `bbs_common_id` int(11) NOT NULL,
  `title` varchar(255) COLLATE utf8mb4_bin NOT NULL,
  `delete_flag` varchar(255) COLLATE utf8mb4_bin NOT NULL,
  `starter` varchar(255) COLLATE utf8mb4_bin NOT NULL,
  ...
  KEY `idx_bbs_common_id` (`bbs_common_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `op_bbs`
--

LOCK TABLES `op_bbs` WRITE;
/*!40000 ALTER TABLE `op_bbs` DISABLE KEYS */;
/*!40000 ALTER TABLE `op_bbs` ENABLE KEYS */;
UNLOCK TABLES;
