...
--
-- Table structure for table `reported_members`
--

DROP TABLE IF EXISTS `reported_members`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `reported_members` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `room_id` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL,
  `report_female_member_id` int(11) DEFAULT NULL,
  `male_member_id` int(11) NOT NULL,
  `chat_mode` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL,
  `reason` varchar(255) COLLATE utf8mb4_bin NOT NULL,
  `reason_text` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL,
...
--
-- Dumping data for table `reported_members`
--

LOCK TABLES `reported_members` WRITE;
/*!40000 ALTER TABLE `reported_members` DISABLE KEYS */;
/*!40000 ALTER TABLE `reported_members` ENABLE KEYS */;
UNLOCK TABLES;
