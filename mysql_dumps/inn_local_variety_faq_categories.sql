...
--
-- Table structure for table `variety_faq_categories`
--

DROP TABLE IF EXISTS `variety_faq_categories`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `variety_faq_categories` (
...
--
-- Dumping data for table `variety_faq_categories`
--

LOCK TABLES `variety_faq_categories` WRITE;
/*!40000 ALTER TABLE `variety_faq_categories` DISABLE KEYS */;
/*!40000 ALTER TABLE `variety_faq_categories` ENABLE KEYS */;
UNLOCK TABLES;
