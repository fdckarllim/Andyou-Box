...
--
-- Table structure for table `variety_event_dlc_buy_goods_change_logs`
--

DROP TABLE IF EXISTS `variety_event_dlc_buy_goods_change_logs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `variety_event_dlc_buy_goods_change_logs` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `variety_event_dlc_buy_goods_id` int(11) NOT NULL,
  ...
  `status_collect` varchar(255) COLLATE utf8mb4_bin NOT NULL DEFAULT 'not_yet',
  `collect_complete_num` int(11) NOT NULL DEFAULT '0',
  `status_upload` varchar(255) COLLATE utf8mb4_bin NOT NULL DEFAULT 'not_yet',
  `upload_complete_num` int(11) NOT NULL DEFAULT '0',
  ...
  `goods_reminder_mail_last_sent_at` datetime DEFAULT NULL,
...
--
-- Dumping data for table `variety_event_dlc_buy_goods_change_logs`
--

LOCK TABLES `variety_event_dlc_buy_goods_change_logs` WRITE;
/*!40000 ALTER TABLE `variety_event_dlc_buy_goods_change_logs` DISABLE KEYS */;
/*!40000 ALTER TABLE `variety_event_dlc_buy_goods_change_logs` ENABLE KEYS */;
UNLOCK TABLES;
