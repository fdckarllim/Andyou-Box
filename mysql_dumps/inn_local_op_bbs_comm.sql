...
--
-- Table structure for table `op_bbs_comm`
--

DROP TABLE IF EXISTS `op_bbs_comm`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `op_bbs_comm` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `service_id` int(11) NOT NULL,
  `thread_id` int(11) NOT NULL,
  `com_body` varchar(255) COLLATE utf8mb4_bin NOT NULL,
  `jam_id` int(11) NOT NULL,
  `female_member_id` int(11) NOT NULL,
  `res_number` int(11) NOT NULL,
  `id_name` varchar(255) COLLATE utf8mb4_bin NOT NULL,
  `delete_flag` int(11) NOT NULL,
  `hold_flag` int(11) NOT NULL,
  `check_flag` int(11) NOT NULL,
  `flag_ident` varchar(255) COLLATE utf8mb4_bin NOT NULL,
  ...
  KEY `idx_flags` (`check_flag`,`hold_flag`,`delete_flag`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `op_bbs_comm`
--

LOCK TABLES `op_bbs_comm` WRITE;
/*!40000 ALTER TABLE `op_bbs_comm` DISABLE KEYS */;
/*!40000 ALTER TABLE `op_bbs_comm` ENABLE KEYS */;
UNLOCK TABLES;
