...
--
-- Table structure for table `staff_introduction`
--
...
CREATE TABLE `staff_introduction` (
  ...
  `kana` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL,
  `sex` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL,
  `blood` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL,
  `start_ym` date DEFAULT NULL,
  `show_status` varchar(255) COLLATE utf8mb4_bin NOT NULL,
  `detail_status` varchar(255) COLLATE utf8mb4_bin NOT NULL,
  `list_photo_id` varchar(1023) COLLATE utf8mb4_bin DEFAULT NULL,
  `detail_photo_id` varchar(1023) COLLATE utf8mb4_bin DEFAULT NULL,
  `main_job` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL,
...
--
-- Dumping data for table `staff_introduction`
--

LOCK TABLES `staff_introduction` WRITE;
/*!40000 ALTER TABLE `staff_introduction` DISABLE KEYS */;
/*!40000 ALTER TABLE `staff_introduction` ENABLE KEYS */;
UNLOCK TABLES;
