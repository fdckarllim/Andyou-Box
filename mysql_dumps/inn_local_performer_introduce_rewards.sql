...
--
-- Table structure for table `performer_introduce_rewards`
--

DROP TABLE IF EXISTS `performer_introduce_rewards`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `performer_introduce_rewards` (
...
--
-- Dumping data for table `performer_introduce_rewards`
--

LOCK TABLES `performer_introduce_rewards` WRITE;
/*!40000 ALTER TABLE `performer_introduce_rewards` DISABLE KEYS */;
/*!40000 ALTER TABLE `performer_introduce_rewards` ENABLE KEYS */;
UNLOCK TABLES;
