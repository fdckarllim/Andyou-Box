...
--
-- Table structure for table `male_credit_regists`
--

DROP TABLE IF EXISTS `male_credit_regists`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `male_credit_regists` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `service_group_id` int(11) NOT NULL,
  `male_member_id` int(11) NOT NULL,
  `site` varchar(255) COLLATE utf8mb4_bin NOT NULL,
  `option` varchar(255) COLLATE utf8mb4_bin NOT NULL,
...
--
-- Dumping data for table `male_credit_regists`
--

LOCK TABLES `male_credit_regists` WRITE;
/*!40000 ALTER TABLE `male_credit_regists` DISABLE KEYS */;
/*!40000 ALTER TABLE `male_credit_regists` ENABLE KEYS */;
UNLOCK TABLES;
