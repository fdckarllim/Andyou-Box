...
--
-- Table structure for table `charge_rate_templates`
--

DROP TABLE IF EXISTS `charge_rate_templates`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `charge_rate_templates` (
...
--
-- Dumping data for table `charge_rate_templates`
--

LOCK TABLES `charge_rate_templates` WRITE;
/*!40000 ALTER TABLE `charge_rate_templates` DISABLE KEYS */;
/*!40000 ALTER TABLE `charge_rate_templates` ENABLE KEYS */;
UNLOCK TABLES;
