...
--
-- Table structure for table `payment_date_texts`
--

DROP TABLE IF EXISTS `payment_date_texts`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `payment_date_texts` (
...
--
-- Dumping data for table `payment_date_texts`
--

LOCK TABLES `payment_date_texts` WRITE;
/*!40000 ALTER TABLE `payment_date_texts` DISABLE KEYS */;
/*!40000 ALTER TABLE `payment_date_texts` ENABLE KEYS */;
UNLOCK TABLES;
