...
--
-- Table structure for table `member_favorite_logs`
--

DROP TABLE IF EXISTS `member_favorite_logs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `member_favorite_logs` (
...
--
-- Dumping data for table `member_favorite_logs`
--

LOCK TABLES `member_favorite_logs` WRITE;
/*!40000 ALTER TABLE `member_favorite_logs` DISABLE KEYS */;
INSERT INTO `member_favorite_logs` VALUES (1,2,7,0,'2017-08-15 11:00:19','127.0.0.1','7','127.0.0.1','7','female_member','female_member','pc','pc','2017-08-15 11:00:19','2017-08-15 11:00:19');
/*!40000 ALTER TABLE `member_favorite_logs` ENABLE KEYS */;
UNLOCK TABLES;
