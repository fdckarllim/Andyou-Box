...
--
-- Table structure for table `tip_points`
--

DROP TABLE IF EXISTS `tip_points`;
...
--
-- Dumping data for table `tip_points`
--

LOCK TABLES `tip_points` WRITE;
/*!40000 ALTER TABLE `tip_points` DISABLE KEYS */;
/*!40000 ALTER TABLE `tip_points` ENABLE KEYS */;
UNLOCK TABLES;
