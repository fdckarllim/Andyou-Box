...
--
-- Table structure for table `variety_mobile_push_admin`
--

DROP TABLE IF EXISTS `variety_mobile_push_admin`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `variety_mobile_push_admin` (
...
--
-- Dumping data for table `variety_mobile_push_admin`
--

LOCK TABLES `variety_mobile_push_admin` WRITE;
/*!40000 ALTER TABLE `variety_mobile_push_admin` DISABLE KEYS */;
/*!40000 ALTER TABLE `variety_mobile_push_admin` ENABLE KEYS */;
UNLOCK TABLES;
