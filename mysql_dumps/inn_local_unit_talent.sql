...
--
-- Table structure for table `unit_talent`
--

DROP TABLE IF EXISTS `unit_talent`;
...
--
-- Dumping data for table `unit_talent`
--

LOCK TABLES `unit_talent` WRITE;
/*!40000 ALTER TABLE `unit_talent` DISABLE KEYS */;
/*!40000 ALTER TABLE `unit_talent` ENABLE KEYS */;
UNLOCK TABLES;
