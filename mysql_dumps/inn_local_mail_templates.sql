...
CREATE TABLE `mail_templates` (
  ...
  `template_type` varchar(255) COLLATE utf8mb4_bin NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_bin NOT NULL,
  `explanation` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL,
  ...
  `footer` varchar(255) COLLATE utf8mb4_bin NOT NULL,
  ...
  KEY `idx_template_type` (`template_type`(127))
