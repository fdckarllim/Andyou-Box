...
--
-- Table structure for table `member_daily_summary_access_logs`
--

DROP TABLE IF EXISTS `member_daily_summary_access_logs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `member_daily_summary_access_logs` (
...
--
-- Dumping data for table `member_daily_summary_access_logs`
--

LOCK TABLES `member_daily_summary_access_logs` WRITE;
/*!40000 ALTER TABLE `member_daily_summary_access_logs` DISABLE KEYS */;
/*!40000 ALTER TABLE `member_daily_summary_access_logs` ENABLE KEYS */;
UNLOCK TABLES;
