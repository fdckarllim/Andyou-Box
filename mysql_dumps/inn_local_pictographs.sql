...
--
-- Table structure for table `pictographs`
--

DROP TABLE IF EXISTS `pictographs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `pictographs` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `embed_key` varchar(255) COLLATE utf8mb4_bin NOT NULL,
...
--
-- Dumping data for table `pictographs`
--

LOCK TABLES `pictographs` WRITE;
/*!40000 ALTER TABLE `pictographs` DISABLE KEYS */;
/*!40000 ALTER TABLE `pictographs` ENABLE KEYS */;
UNLOCK TABLES;
