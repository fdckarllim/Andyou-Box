...
--
-- Table structure for table `point_money_rates`
--

DROP TABLE IF EXISTS `point_money_rates`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `point_money_rates` (
...
--
-- Dumping data for table `point_money_rates`
--

LOCK TABLES `point_money_rates` WRITE;
/*!40000 ALTER TABLE `point_money_rates` DISABLE KEYS */;
/*!40000 ALTER TABLE `point_money_rates` ENABLE KEYS */;
UNLOCK TABLES;
