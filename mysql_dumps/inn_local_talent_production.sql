...
--
-- Table structure for table `talent_production`
--

DROP TABLE IF EXISTS `talent_production`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `talent_production` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `talent_id` varchar(255) COLLATE utf8mb4_bin NOT NULL,
...
--
-- Dumping data for table `talent_production`
--

LOCK TABLES `talent_production` WRITE;
/*!40000 ALTER TABLE `talent_production` DISABLE KEYS */;
/*!40000 ALTER TABLE `talent_production` ENABLE KEYS */;
UNLOCK TABLES;
