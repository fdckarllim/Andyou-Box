...
--
-- Table structure for table `pay_log_details`
--

DROP TABLE IF EXISTS `pay_log_details`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `pay_log_details` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `pay_log_id` int(11) NOT NULL,
  `first_flag` int(11) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `pay_log_details`
--

LOCK TABLES `pay_log_details` WRITE;
/*!40000 ALTER TABLE `pay_log_details` DISABLE KEYS */;
/*!40000 ALTER TABLE `pay_log_details` ENABLE KEYS */;
UNLOCK TABLES;
