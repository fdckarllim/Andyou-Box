...
--
-- Table structure for table `male_favorite_talents`
--

DROP TABLE IF EXISTS `male_favorite_talents`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `male_favorite_talents` (
...
--
-- Dumping data for table `male_favorite_talents`
--

LOCK TABLES `male_favorite_talents` WRITE;
/*!40000 ALTER TABLE `male_favorite_talents` DISABLE KEYS */;
/*!40000 ALTER TABLE `male_favorite_talents` ENABLE KEYS */;
UNLOCK TABLES;
