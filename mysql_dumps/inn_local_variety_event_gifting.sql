...
--
-- Table structure for table `variety_event_gifting`
--

DROP TABLE IF EXISTS `variety_event_gifting`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `variety_event_gifting` (
...
--
-- Dumping data for table `variety_event_gifting`
--

LOCK TABLES `variety_event_gifting` WRITE;
/*!40000 ALTER TABLE `variety_event_gifting` DISABLE KEYS */;
/*!40000 ALTER TABLE `variety_event_gifting` ENABLE KEYS */;
UNLOCK TABLES;
