...
CREATE TABLE `bonus` (
  ...
  `seisan_id` bigint(20) DEFAULT NULL,
  `female_point_log_id` bigint(20) DEFAULT NULL,
  `note` varchar(255) COLLATE utf8mb4_bin NOT NULL,
  `female_note` varchar(255) COLLATE utf8mb4_bin NOT NULL,
  `status` varchar(255) COLLATE utf8mb4_bin NOT NULL DEFAULT 'yet',
