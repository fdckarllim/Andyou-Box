...
--
-- Table structure for table `variety_event_performers`
--

DROP TABLE IF EXISTS `variety_event_performers`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `variety_event_performers` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `variety_event_id` int(11) NOT NULL,
  `talent_id` int(11) DEFAULT NULL,
  `unit_id` int(11) DEFAULT NULL,
  `variety_production_id` int(11) DEFAULT NULL,
  `is_private_office` tinyint(1) NOT NULL,
  `entry_no` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL,
  `information_open_flag` tinyint(1) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `variety_event_performers`
--

LOCK TABLES `variety_event_performers` WRITE;
/*!40000 ALTER TABLE `variety_event_performers` DISABLE KEYS */;
/*!40000 ALTER TABLE `variety_event_performers` ENABLE KEYS */;
UNLOCK TABLES;
