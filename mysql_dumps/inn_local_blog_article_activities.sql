...
--
-- Table structure for table `blog_article_activities`
--

DROP TABLE IF EXISTS `blog_article_activities`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `blog_article_activities` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `blog_article_id` int(11) NOT NULL,
  `act_type` varchar(255) COLLATE utf8mb4_bin NOT NULL,
  `act_id` int(11) DEFAULT NULL,
  `cre_type` varchar(255) COLLATE utf8mb4_bin DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `idx_blog_article_id` (`blog_article_id`),
  KEY `idx_act_id` (`act_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `blog_article_activities`
--

LOCK TABLES `blog_article_activities` WRITE;
/*!40000 ALTER TABLE `blog_article_activities` DISABLE KEYS */;
/*!40000 ALTER TABLE `blog_article_activities` ENABLE KEYS */;
UNLOCK TABLES;
