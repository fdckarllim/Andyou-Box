...
--
-- Table structure for table `variety_event_ranking_departments`
--

DROP TABLE IF EXISTS `variety_event_ranking_departments`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `variety_event_ranking_departments` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `variety_event_ranking_id` int(11) NOT NULL,
...
--
-- Dumping data for table `variety_event_ranking_departments`
--

LOCK TABLES `variety_event_ranking_departments` WRITE;
/*!40000 ALTER TABLE `variety_event_ranking_departments` DISABLE KEYS */;
/*!40000 ALTER TABLE `variety_event_ranking_departments` ENABLE KEYS */;
UNLOCK TABLES;
