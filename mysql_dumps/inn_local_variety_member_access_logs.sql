...
--
-- Table structure for table `variety_member_access_logs`
--

DROP TABLE IF EXISTS `variety_member_access_logs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `variety_member_access_logs` (
...
--
-- Dumping data for table `variety_member_access_logs`
--

LOCK TABLES `variety_member_access_logs` WRITE;
/*!40000 ALTER TABLE `variety_member_access_logs` DISABLE KEYS */;
/*!40000 ALTER TABLE `variety_member_access_logs` ENABLE KEYS */;
UNLOCK TABLES;
