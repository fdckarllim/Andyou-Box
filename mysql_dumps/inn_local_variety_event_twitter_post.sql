...
--
-- Table structure for table `variety_event_twitter_post`
--

DROP TABLE IF EXISTS `variety_event_twitter_post`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `variety_event_twitter_post` (
  ...
  `tweet_img_url` varchar(1023) COLLATE utf8mb4_bin NOT NULL,
...
--
-- Dumping data for table `variety_event_twitter_post`
--

LOCK TABLES `variety_event_twitter_post` WRITE;
/*!40000 ALTER TABLE `variety_event_twitter_post` DISABLE KEYS */;
/*!40000 ALTER TABLE `variety_event_twitter_post` ENABLE KEYS */;
UNLOCK TABLES;
