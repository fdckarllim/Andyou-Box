...
--
-- Table structure for table `op_bbs_kanri_logs`
--

DROP TABLE IF EXISTS `op_bbs_kanri_logs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `op_bbs_kanri_logs` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `service_id` int(11) NOT NULL,
  `op_bbs_comm_id` int(11) NOT NULL,
  ...
  KEY `idx_op_bbs_comm_id` (`op_bbs_comm_id`),
  KEY `idx_upd_role` (`upd_role`(127))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `op_bbs_kanri_logs`
--

LOCK TABLES `op_bbs_kanri_logs` WRITE;
/*!40000 ALTER TABLE `op_bbs_kanri_logs` DISABLE KEYS */;
/*!40000 ALTER TABLE `op_bbs_kanri_logs` ENABLE KEYS */;
UNLOCK TABLES;
