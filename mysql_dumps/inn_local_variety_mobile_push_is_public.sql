...
--
-- Table structure for table `variety_mobile_push_is_public`
--

DROP TABLE IF EXISTS `variety_mobile_push_is_public`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `variety_mobile_push_is_public` (
...
--
-- Dumping data for table `variety_mobile_push_is_public`
--

LOCK TABLES `variety_mobile_push_is_public` WRITE;
/*!40000 ALTER TABLE `variety_mobile_push_is_public` DISABLE KEYS */;
/*!40000 ALTER TABLE `variety_mobile_push_is_public` ENABLE KEYS */;
UNLOCK TABLES;
